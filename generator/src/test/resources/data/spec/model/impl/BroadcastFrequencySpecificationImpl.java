...
public class BroadcastFrequencySpecificationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements BroadcastFrequencySpecification {
    ...
    private List<Object> broadcastSignalModulation;
     ...
     */
    @Override
    public <T> List<T> getBroadcastSignalModulationList() {
        return (List<T>) broadcastSignalModulation;
    }
    ...
    public <T> T getBroadcastSignalModulation() {
        return (T) getFirst(broadcastSignalModulation);
    }
     ...
     */
    @Override
    public void addBroadcastSignalModulation(Text broadcastSignalModulation) {
        this.broadcastSignalModulation = add(this.broadcastSignalModulation, broadcastSignalModulation);
    }
    /**
     * The modulation (e.g. FM, AM, etc) used by a particular broadcast service.
     *
     ...
     */
    @Override
    public void addBroadcastSignalModulation(QualitativeValue broadcastSignalModulation) {
        this.broadcastSignalModulation = add(this.broadcastSignalModulation, broadcastSignalModulation);
    }

    private List<Text> broadcastSubChannel;
     ...
     */
    @Override
    public List<Text> getBroadcastSubChannelList() {
    ...
    public Text getBroadcastSubChannel() {
        return getFirst(broadcastSubChannel);
    }
     ...
     */
    @Override
    public void addBroadcastSubChannel(Text broadcastSubChannel) {
        this.broadcastSubChannel = add(this.broadcastSubChannel, broadcastSubChannel);
    }

    @JsonLdFieldTypes({ Number.class, QuantitativeValue.class })
    private List<Object> broadcastFrequencyValue;
     ...
     */
    @Override
    public <T> List<T> getBroadcastFrequencyValueList() {
        return (List<T>) broadcastFrequencyValue;
    }
    ...
    public <T> T getBroadcastFrequencyValue() {
        return (T) getFirst(broadcastFrequencyValue);
    }
     ...
     */
    @Override
    public void addBroadcastFrequencyValue(Number broadcastFrequencyValue) {
        this.broadcastFrequencyValue = add(this.broadcastFrequencyValue, broadcastFrequencyValue);
    }
    /**
     * The frequency in MHz for a particular broadcast.
     *
     ...
     */
    @Override
    public void addBroadcastFrequencyValue(QuantitativeValue broadcastFrequencyValue) {
        this.broadcastFrequencyValue = add(this.broadcastFrequencyValue, broadcastFrequencyValue);
    }
