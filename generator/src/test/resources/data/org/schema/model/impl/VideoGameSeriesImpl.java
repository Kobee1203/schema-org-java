...
public class VideoGameSeriesImpl implements VideoGameSeries {
     ...
     */
    @Override
    public void setSeason(Object fSeason) {
        if(!(fSeason instanceof URL) && !(fSeason instanceof CreativeWorkSeason)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'season': " + fSeason);
        }
     ...
     */
    @Override
    public void setGamePlatform(Object fGamePlatform) {
        if(!(fGamePlatform instanceof Text) && !(fGamePlatform instanceof URL) && !(fGamePlatform instanceof Thing)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'gamePlatform': " + fGamePlatform);
        }
     ...
     */
    @Override
    public void setMusicBy(Object fMusicBy) {
        if(!(fMusicBy instanceof Person) && !(fMusicBy instanceof MusicGroup)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'musicBy': " + fMusicBy);
        }
     ...
     */
    @Override
    public void setGameLocation(Object fGameLocation) {
        if(!(fGameLocation instanceof Place) && !(fGameLocation instanceof URL) && !(fGameLocation instanceof PostalAddress)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'gameLocation': " + fGameLocation);
        }
