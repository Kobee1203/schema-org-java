...
public class SellActionImpl implements SellAction {
     ...
     */
    @Override
    public void setBuyer(Object fBuyer) {
        if(!(fBuyer instanceof Person) && !(fBuyer instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'buyer': " + fBuyer);
        }
        this.fBuyer = fBuyer;
    }
     ...
     */
    @Override
    public void setWarrantyPromise(WarrantyPromise fWarrantyPromise) {
        this.fWarrantyPromise = fWarrantyPromise;
    }
