...
public class NerveImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Nerve {
    ...
    private List<Muscle> nerveMotor;
     ...
     */
    @Override
    public List<Muscle> getNerveMotorList() {
        return nerveMotor;
    }
     ...
     */
    @Override
    public void addNerveMotor(Muscle nerveMotor) {
        this.nerveMotor = add(this.nerveMotor, nerveMotor);
    }

    private List<AnatomicalStructure> branch;
     ...
     */
    @Override
    public List<AnatomicalStructure> getBranchList() {
        return branch;
    }
     ...
     */
    @Override
    public void addBranch(AnatomicalStructure branch) {
        this.branch = add(this.branch, branch);
    }

    private List<BrainStructure> sourcedFrom;
     ...
     */
    @Override
    public List<BrainStructure> getSourcedFromList() {
        return sourcedFrom;
    }
     ...
     */
    @Override
    public void addSourcedFrom(BrainStructure sourcedFrom) {
        this.sourcedFrom = add(this.sourcedFrom, sourcedFrom);
    }

    @JsonLdFieldTypes({ AnatomicalStructure.class, SuperficialAnatomy.class })
    private List<Object> sensoryUnit;
     ...
     */
    @Override
    public <T> List<T> getSensoryUnitList() {
        return (List<T>) sensoryUnit;
    }
     ...
     */
    @Override
    public void addSensoryUnit(AnatomicalStructure sensoryUnit) {
        this.sensoryUnit = add(this.sensoryUnit, sensoryUnit);
    }
    /**
     * The neurological pathway extension that inputs and sends information to the brain or spinal cord.
     *
     ...
     */
    @Override
    public void addSensoryUnit(SuperficialAnatomy sensoryUnit) {
        this.sensoryUnit = add(this.sensoryUnit, sensoryUnit);
    }
