...
public class BorrowActionImpl implements BorrowAction {
     ...
     */
    @Override
    public void setLender(Object fLender) {
        if(!(fLender instanceof Person) && !(fLender instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'lender': " + fLender);
        }
        this.fLender = fLender;
    }
