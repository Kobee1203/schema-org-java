...
public class AirportImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Airport {
     ...
     */
    @Override
    public List<Text> getIcaoCodeList() {
        return icaoCode;
    }
     ...
     */
    @Override
    public Text getIcaoCode() {
        return getFirst(icaoCode);
    }
     ...
     */
    @Override
    public void addIcaoCode(Text icaoCode) {
        this.icaoCode = add(this.icaoCode, icaoCode);
    }
