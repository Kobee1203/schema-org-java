...
import org.schema.model.models.Distance;
import org.schema.model.models.Duration;
import org.schema.model.models.Event;
import org.schema.model.models.GeoShape;
...
import org.schema.model.models.MediaSubscription;
import org.schema.model.models.MusicGroup;
import org.schema.model.models.MusicRecording;
import org.schema.model.models.NewsArticle;
import org.schema.model.models.Offer;
import org.schema.model.models.Organization;
import org.schema.model.models.PerformingGroup;
...
public class VideoObjectImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements VideoObject {
     ...
     */
    @Override
    public List<Text> getTranscriptList() {
        return transcript;
    }
     ...
     */
    @Override
    public void addTranscript(Text transcript) {
        this.transcript = add(this.transcript, transcript);
    }
    ...
    private List<Text> videoFrameSize;
     ...
     */
    @Override
    public List<Text> getVideoFrameSizeList() {
     ...
     */
    @Override
    public Text getVideoFrameSize() {
        return getFirst(videoFrameSize);
    }
     ...
     */
    @Override
    public void addVideoFrameSize(Text videoFrameSize) {
        this.videoFrameSize = add(this.videoFrameSize, videoFrameSize);
    }
     ...
     */
    @Override
    public <T> List<T> getCaptionList() {
        return (List<T>) caption;
    }
    ...
    public void addCaption(Text caption) {
        this.caption = add(this.caption, caption);
    }
    /**
     * The caption for this object. For downloadable machine formats (closed caption, subtitles etc.) use MediaObject and indicate the [[encodingFormat]].
     *
     ...
     */
    @Override
    public void addCaption(MediaObject caption) {
        this.caption = add(this.caption, caption);
    }
    ...
    private List<Text> embeddedTextCaption;
    ...
    public Text getEmbeddedTextCaption() {
        return getFirst(embeddedTextCaption);
    }
    ...
    public void addEmbeddedTextCaption(Text embeddedTextCaption) {
        this.embeddedTextCaption = add(this.embeddedTextCaption, embeddedTextCaption);
    }

    private List<Text> videoQuality;
     ...
     */
    @Override
    public List<Text> getVideoQualityList() {
        return videoQuality;
    }
     ...
     */
    @Override
    public Text getVideoQuality() {
        return getFirst(videoQuality);
    }
     ...
     */
    @Override
    public void addVideoQuality(Text videoQuality) {
        this.videoQuality = add(this.videoQuality, videoQuality);
    }
