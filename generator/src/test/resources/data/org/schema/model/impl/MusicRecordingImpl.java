...
public class MusicRecordingImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MusicRecording {
    ...
    private List<MusicAlbum> inAlbum;
     ...
     */
    @Override
    public List<MusicAlbum> getInAlbumList() {
        return inAlbum;
    }
     ...
     */
    @Override
    public void addInAlbum(MusicAlbum inAlbum) {
        this.inAlbum = add(this.inAlbum, inAlbum);
    }
    ...
    public void addIsrcCode(Text isrcCode) {
        this.isrcCode = add(this.isrcCode, isrcCode);
    }

    private List<MusicComposition> recordingOf;
    ...
    public void addRecordingOf(MusicComposition recordingOf) {
        this.recordingOf = add(this.recordingOf, recordingOf);
    }

    private List<MusicPlaylist> inPlaylist;
     ...
     */
    @Override
    public List<MusicPlaylist> getInPlaylistList() {
        return inPlaylist;
    }
     ...
     */
    @Override
    public void addInPlaylist(MusicPlaylist inPlaylist) {
        this.inPlaylist = add(this.inPlaylist, inPlaylist);
    }
