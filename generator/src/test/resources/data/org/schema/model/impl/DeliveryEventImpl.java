...
public class DeliveryEventImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements DeliveryEvent {
     ...
     */
    @Override
    public void setAccessCode(Text fAccessCode) {
     ...
     */
    @Override
    public void setAccessCode(java.lang.String fAccessCode) {
        this.fAccessCode = Text.of(fAccessCode);
    }

    private DateTime fAvailableThrough;
     ...
     */
    @Override
    public void setAvailableThrough(DateTime fAvailableThrough) {
        this.fAvailableThrough = fAvailableThrough;
    }
    /**
     * After this date, the item will no longer be available for pickup.
     *
     ...
     */
    @Override
    public void setAvailableThrough(java.time.LocalDateTime fAvailableThrough) {
        this.fAvailableThrough = DateTime.of(fAvailableThrough);
    }
    ...
    private DateTime fAvailableFrom;
     ...
     */
    @Override
    public void setAvailableFrom(DateTime fAvailableFrom) {
        this.fAvailableFrom = fAvailableFrom;
    }
    /**
     * When the item is available for pickup from the store, locker, etc.
     *
     ...
     */
    @Override
    public void setAvailableFrom(java.time.LocalDateTime fAvailableFrom) {
        this.fAvailableFrom = DateTime.of(fAvailableFrom);
    }
