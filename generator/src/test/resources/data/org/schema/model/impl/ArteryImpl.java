...
public class ArteryImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Artery {
     ...
     * The area to which the artery supplies blood.
     *
     * @param fSupplyTo AnatomicalStructure value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setSupplyTo(AnatomicalStructure fSupplyTo) {
        this.fSupplyTo = fSupplyTo;
    }

    private AnatomicalStructure fArterialBranch;
    ...
    public AnatomicalStructure getArterialBranch() {
        return fArterialBranch;
    }

    /**
     * The branches that comprise the arterial structure.
     *
     * @param fArterialBranch AnatomicalStructure value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setArterialBranch(AnatomicalStructure fArterialBranch) {
        this.fArterialBranch = fArterialBranch;
    }
