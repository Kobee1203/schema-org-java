...
public class TVClipImpl implements TVClip {
     ...
     */
    @Override
    public void setStartOffset(Object fStartOffset) {
        if(!(fStartOffset instanceof Number) && !(fStartOffset instanceof HyperTocEntry)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'startOffset': " + fStartOffset);
        }
        this.fStartOffset = fStartOffset;
    }

    private Object fEndOffset;
     ...
     */
    @Override
    public void setEndOffset(Object fEndOffset) {
        if(!(fEndOffset instanceof Number) && !(fEndOffset instanceof HyperTocEntry)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'endOffset': " + fEndOffset);
        }
    ...
    private Episode fPartOfEpisode;
     ...
     */
    @Override
    public void setPartOfEpisode(Episode fPartOfEpisode) {
        this.fPartOfEpisode = fPartOfEpisode;
    }

    private Object fClipNumber;
     ...
     */
    @Override
    public void setClipNumber(Object fClipNumber) {
        if(!(fClipNumber instanceof Text) && !(fClipNumber instanceof Integer)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'clipNumber': " + fClipNumber);
        }
        this.fClipNumber = fClipNumber;
    }
