...
public class JointImpl implements Joint {
     ...
     */
    @Override
    public void setFunctionalClass(Object fFunctionalClass) {
        if(!(fFunctionalClass instanceof Text) && !(fFunctionalClass instanceof MedicalEntity)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'functionalClass': " + fFunctionalClass);
        }
