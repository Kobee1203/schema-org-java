...
public class QuotationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Quotation {
     ...
     */
    @Override
    public void setSpokenByCharacter(Object fSpokenByCharacter) {
        if(!(fSpokenByCharacter instanceof Person) && !(fSpokenByCharacter instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'spokenByCharacter': " + fSpokenByCharacter);
        }
        this.fSpokenByCharacter = fSpokenByCharacter;
    }
