...
import org.schema.model.Quotation;
...
public class QuotationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Quotation {
    ...
    private List<Object> spokenByCharacter;
     ...
     */
    @Override
    public <T> List<T> getSpokenByCharacterList() {
        return (List<T>) spokenByCharacter;
    }
     ...
     */
    @Override
    public <T> T getSpokenByCharacter() {
        return (T) getFirst(spokenByCharacter);
    }
     ...
     */
    @Override
    public void addSpokenByCharacter(Person spokenByCharacter) {
        this.spokenByCharacter = add(this.spokenByCharacter, spokenByCharacter);
    }
    /**
     * The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork.
     *
     ...
     */
    @Override
    public void addSpokenByCharacter(Organization spokenByCharacter) {
        this.spokenByCharacter = add(this.spokenByCharacter, spokenByCharacter);
    }
