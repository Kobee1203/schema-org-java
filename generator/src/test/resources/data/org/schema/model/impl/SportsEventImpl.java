...
public class SportsEventImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SportsEvent {
    ...
    @JsonLdFieldTypes({ SportsTeam.class, Person.class })
    private List<Object> awayTeam;

    @Override
    public <T> List<T> getAwayTeamList() {
        return (List<T>) awayTeam;
    }

    @Override
    public <T> T getAwayTeam() {
        return (T) getFirst(awayTeam);
    }

    @Override
    public void addAwayTeam(SportsTeam awayTeam) {
        this.awayTeam = add(this.awayTeam, awayTeam);
    }
    @Override
    ...
    @JsonLdFieldTypes({ Person.class, SportsTeam.class })
    private List<Object> competitor;

    @Override
    public <T> List<T> getCompetitorList() {
        return (List<T>) competitor;
    }

    @Override
    public <T> T getCompetitor() {
        return (T) getFirst(competitor);
    }

    @Override
    public void addCompetitor(Person competitor) {
        this.competitor = add(this.competitor, competitor);
    }
    @Override
    public void addCompetitor(SportsTeam competitor) {
        this.competitor = add(this.competitor, competitor);
    }
    ...
    public <T> List<T> getHomeTeamList() {
        return (List<T>) homeTeam;
    }

    @Override
    public <T> T getHomeTeam() {
        return (T) getFirst(homeTeam);
    }

    @Override
    public void addHomeTeam(Person homeTeam) {
        this.homeTeam = add(this.homeTeam, homeTeam);
    }
    @Override
    ...
    public Person getReferee() {
        return getFirst(referee);
    }

    @Override
    public void addReferee(Person referee) {
        this.referee = add(this.referee, referee);
    }
