...
public class BuyActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements BuyAction {
     ...
     */
    @Override
    public void setVendor(Object fVendor) {
        if(!(fVendor instanceof Person) && !(fVendor instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'vendor': " + fVendor);
        }
