...
public class DietImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Diet {
     ...
     */
    @Override
    public void setEndorsers(Object fEndorsers) {
        if(!(fEndorsers instanceof Person) && !(fEndorsers instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'endorsers': " + fEndorsers);
        }
