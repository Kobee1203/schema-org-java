...
public class CreativeWorkSeasonImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CreativeWorkSeason {
    ...
    private List<Object> seasonNumber;
     ...
     */
    @Override
    public <T> List<T> getSeasonNumberList() {
        return (List<T>) seasonNumber;
    }
     ...
     */
    @Override
    public <T> T getSeasonNumber() {
        return (T) getFirst(seasonNumber);
    }
     ...
     */
    @Override
    public void addSeasonNumber(Text seasonNumber) {
        this.seasonNumber = add(this.seasonNumber, seasonNumber);
    }
    /**
     * Position of the season within an ordered group of seasons.
     *
     ...
     */
    @Override
    public void addSeasonNumber(Integer seasonNumber) {
        this.seasonNumber = add(this.seasonNumber, seasonNumber);
    }
