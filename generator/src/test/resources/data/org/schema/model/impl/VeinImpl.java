...
public class VeinImpl implements Vein {
     ...
     */
    @Override
    public void setRegionDrained(Object fRegionDrained) {
        if(!(fRegionDrained instanceof AnatomicalSystem) && !(fRegionDrained instanceof AnatomicalStructure)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'regionDrained': " + fRegionDrained);
        }
        this.fRegionDrained = fRegionDrained;
    }
    ...
    private AnatomicalStructure fTributary;
     ...
     */
    @Override
    public void setTributary(AnatomicalStructure fTributary) {
        this.fTributary = fTributary;
    }
     ...
     */
    @Override
    public void setDrainsTo(Vessel fDrainsTo) {
        this.fDrainsTo = fDrainsTo;
    }
