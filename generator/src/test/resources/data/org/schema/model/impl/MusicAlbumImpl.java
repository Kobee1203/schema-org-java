...
import org.schema.model.models.MusicAlbumProductionType;
import org.schema.model.models.MusicAlbumReleaseType;
import org.schema.model.models.MusicGroup;
import org.schema.model.models.MusicPlaylist;
import org.schema.model.models.MusicRecording;
import org.schema.model.models.MusicRelease;
...
public class MusicAlbumImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MusicAlbum {
     ...
     */
    @Override
    public <T> List<T> getByArtistList() {
        return (List<T>) byArtist;
    }
     ...
     */
    @Override
    public <T> T getByArtist() {
        return (T) getFirst(byArtist);
    }
     ...
     */
    @Override
    public void addByArtist(Person byArtist) {
        this.byArtist = add(this.byArtist, byArtist);
    }
    /**
     * The artist that performed this album or recording.
     *
     ...
     */
    @Override
    public void addByArtist(MusicGroup byArtist) {
        this.byArtist = add(this.byArtist, byArtist);
    }

    private List<MusicRelease> albumRelease;
     ...
     */
    @Override
    public List<MusicRelease> getAlbumReleaseList() {
        return albumRelease;
    }
     ...
     */
    @Override
    public void addAlbumRelease(MusicRelease albumRelease) {
        this.albumRelease = add(this.albumRelease, albumRelease);
    }

    private List<MusicAlbumReleaseType> albumReleaseType;
    ...
    public MusicAlbumReleaseType getAlbumReleaseType() {
        return getFirst(albumReleaseType);
    }
    ...
    public void addAlbumReleaseType(MusicAlbumReleaseType albumReleaseType) {
        this.albumReleaseType = add(this.albumReleaseType, albumReleaseType);
    }

    private List<MusicAlbumProductionType> albumProductionType;
    ...
    public MusicAlbumProductionType getAlbumProductionType() {
        return getFirst(albumProductionType);
    }
    ...
    public void addAlbumProductionType(MusicAlbumProductionType albumProductionType) {
        this.albumProductionType = add(this.albumProductionType, albumProductionType);
    }
