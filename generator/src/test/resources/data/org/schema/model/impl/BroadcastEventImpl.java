...
public class BroadcastEventImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements BroadcastEvent {
    ...
    private List<Event> broadcastOfEvent;
     ...
     */
    @Override
    public List<Event> getBroadcastOfEventList() {
    ...
    public Event getBroadcastOfEvent() {
        return getFirst(broadcastOfEvent);
    }
     ...
     */
    @Override
    public void addBroadcastOfEvent(Event broadcastOfEvent) {
        this.broadcastOfEvent = add(this.broadcastOfEvent, broadcastOfEvent);
    }
    ...
    private List<Boolean> isLiveBroadcast;
     ...
     */
    @Override
    public List<Boolean> getIsLiveBroadcastList() {
    ...
    public Boolean getIsLiveBroadcast() {
        return getFirst(isLiveBroadcast);
    }
     ...
     */
    @Override
    public void addIsLiveBroadcast(Boolean isLiveBroadcast) {
        this.isLiveBroadcast = add(this.isLiveBroadcast, isLiveBroadcast);
    }

    @JsonLdFieldTypes({ Organization.class, Person.class })
    private List<Object> publishedBy;
     ...
     */
    @Override
    public <T> List<T> getPublishedByList() {
        return (List<T>) publishedBy;
    }
     ...
     */
    @Override
    public <T> T getPublishedBy() {
        return (T) getFirst(publishedBy);
    }
     ...
     */
    @Override
    public void addPublishedBy(Organization publishedBy) {
        this.publishedBy = add(this.publishedBy, publishedBy);
    }
    /**
     * An agent associated with the publication event.
     *
     ...
     */
    @Override
    public void addPublishedBy(Person publishedBy) {
        this.publishedBy = add(this.publishedBy, publishedBy);
    }
     ...
     */
    @Override
    public List<Boolean> getFreeList() {
        return free;
    }
    ...
    public void addFree(Boolean free) {
        this.free = add(this.free, free);
    }

    private List<BroadcastService> publishedOn;
     ...
     */
    @Override
    public List<BroadcastService> getPublishedOnList() {
        return publishedOn;
    }
     ...
     */
    @Override
    public void addPublishedOn(BroadcastService publishedOn) {
        this.publishedOn = add(this.publishedOn, publishedOn);
    }
