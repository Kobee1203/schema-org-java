...
public class BroadcastEventImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements BroadcastEvent {
    ...
    private Event fBroadcastOfEvent;
     ...
     */
    @Override
    public void setBroadcastOfEvent(Event fBroadcastOfEvent) {
        this.fBroadcastOfEvent = fBroadcastOfEvent;
    }

    private Boolean fIsLiveBroadcast;
     ...
     */
    @Override
    public void setIsLiveBroadcast(Boolean fIsLiveBroadcast) {
        this.fIsLiveBroadcast = fIsLiveBroadcast;
    }
    /**
     * True if the broadcast is of a live event.
     *
     ...
     */
    @Override
    public void setIsLiveBroadcast(java.lang.Boolean fIsLiveBroadcast) {
        this.fIsLiveBroadcast = Boolean.of(fIsLiveBroadcast);
    }
     ...
     */
    @Override
    public void setPublishedBy(Organization fPublishedBy) {
        this.fPublishedBy = fPublishedBy;
    }
    /**
     * An agent associated with the publication event.
     *
     ...
     */
    @Override
    public void setPublishedBy(Person fPublishedBy) {
        this.fPublishedBy = fPublishedBy;
    }
     ...
     */
    @Override
    public void setFree(Boolean fFree) {
        this.fFree = fFree;
    }
    /**
     * A flag to signal that the item, event, or place is accessible for free.
     ...
     */
    @Override
    public void setFree(java.lang.Boolean fFree) {
        this.fFree = Boolean.of(fFree);
    }

    private BroadcastService fPublishedOn;
     ...
     */
    @Override
    public void setPublishedOn(BroadcastService fPublishedOn) {
        this.fPublishedOn = fPublishedOn;
    }
