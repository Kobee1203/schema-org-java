...
import org.schema.model.IndividualPhysician;
 ...
 */
@JsonLdTypeName("IndividualPhysician")
public class IndividualPhysicianImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements IndividualPhysician {

    private List<MedicalOrganization> practicesAt;
     ...
     */
    @Override
    public List<MedicalOrganization> getPracticesAtList() {
        return practicesAt;
    }
     ...
     */
    @Override
    public void addPracticesAt(MedicalOrganization practicesAt) {
        this.practicesAt = add(this.practicesAt, practicesAt);
    }
     ...
     */
    @Override
    public Text getUsNPI() {
        return getFirst(usNPI);
    }
     ...
     */
    @Override
    public void addUsNPI(Text usNPI) {
        this.usNPI = add(this.usNPI, usNPI);
    }

    private List<Hospital> hospitalAffiliation;
     ...
     */
    @Override
    public List<Hospital> getHospitalAffiliationList() {
    ...
    public Hospital getHospitalAffiliation() {
        return getFirst(hospitalAffiliation);
    }
     ...
     */
    @Override
    public void addHospitalAffiliation(Hospital hospitalAffiliation) {
        this.hospitalAffiliation = add(this.hospitalAffiliation, hospitalAffiliation);
    }
    ...
    @JsonLdFieldTypes({ MedicalProcedure.class, MedicalTest.class, MedicalTherapy.class })
    private List<Object> availableService;
     ...
     */
    @Override
    public <T> List<T> getAvailableServiceList() {
        return (List<T>) availableService;
    }
    ...
    public <T> T getAvailableService() {
        return (T) getFirst(availableService);
    }
     ...
     */
    @Override
    public void addAvailableService(MedicalProcedure availableService) {
        this.availableService = add(this.availableService, availableService);
    }
    /**
     * A medical service available from this provider.
     *
     ...
     */
    @Override
    public void addAvailableService(MedicalTest availableService) {
        this.availableService = add(this.availableService, availableService);
    }
    /**
     * A medical service available from this provider.
     ...
     */
    @Override
    public void addAvailableService(MedicalTherapy availableService) {
        this.availableService = add(this.availableService, availableService);
    }
