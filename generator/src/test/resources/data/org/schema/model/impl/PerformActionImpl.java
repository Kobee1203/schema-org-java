...
public class PerformActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements PerformAction {
    ...
    public EntertainmentBusiness getEntertainmentBusiness() {
        return fEntertainmentBusiness;
    }

    /**
     * A sub property of location. The entertainment business where the action occurred.
     *
     * @param fEntertainmentBusiness EntertainmentBusiness value to set.
     */
    @Override
    public void setEntertainmentBusiness(EntertainmentBusiness fEntertainmentBusiness) {
        this.fEntertainmentBusiness = fEntertainmentBusiness;
    }
