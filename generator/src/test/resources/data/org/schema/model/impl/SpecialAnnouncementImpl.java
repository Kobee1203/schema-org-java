...
import org.schema.model.SpecialAnnouncement;
...
public class SpecialAnnouncementImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SpecialAnnouncement {
    ...
    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> schoolClosuresInfo;
     ...
     */
    @Override
    public <T> List<T> getSchoolClosuresInfoList() {
        return (List<T>) schoolClosuresInfo;
    }
     ...
     */
    @Override
    public <T> T getSchoolClosuresInfo() {
        return (T) getFirst(schoolClosuresInfo);
    }
     ...
     */
    @Override
    public void addSchoolClosuresInfo(URL schoolClosuresInfo) {
        this.schoolClosuresInfo = add(this.schoolClosuresInfo, schoolClosuresInfo);
    }
    /**
     * Information about school closures.
     *
     ...
     */
    @Override
    public void addSchoolClosuresInfo(WebContent schoolClosuresInfo) {
        this.schoolClosuresInfo = add(this.schoolClosuresInfo, schoolClosuresInfo);
    }

    private List<GovernmentService> governmentBenefitsInfo;
     ...
     */
    @Override
    public List<GovernmentService> getGovernmentBenefitsInfoList() {
    ...
    public GovernmentService getGovernmentBenefitsInfo() {
        return getFirst(governmentBenefitsInfo);
    }
     ...
     */
    @Override
    public void addGovernmentBenefitsInfo(GovernmentService governmentBenefitsInfo) {
        this.governmentBenefitsInfo = add(this.governmentBenefitsInfo, governmentBenefitsInfo);
    }

    @JsonLdFieldTypes({ DataFeed.class, URL.class })
    private List<Object> webFeed;
     ...
     */
    @Override
    public <T> List<T> getWebFeedList() {
        return (List<T>) webFeed;
    }
     ...
     */
    @Override
    public <T> T getWebFeed() {
        return (T) getFirst(webFeed);
    }
     ...
     */
    @Override
    public void addWebFeed(DataFeed webFeed) {
        this.webFeed = add(this.webFeed, webFeed);
    }
    /**
     * The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom.
     *
     ...
     */
    @Override
    public void addWebFeed(URL webFeed) {
        this.webFeed = add(this.webFeed, webFeed);
    }

    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> publicTransportClosuresInfo;
     ...
     */
    @Override
    public <T> List<T> getPublicTransportClosuresInfoList() {
        return (List<T>) publicTransportClosuresInfo;
    }
     ...
     */
    @Override
    public <T> T getPublicTransportClosuresInfo() {
        return (T) getFirst(publicTransportClosuresInfo);
    }
     ...
     */
    @Override
    public void addPublicTransportClosuresInfo(URL publicTransportClosuresInfo) {
        this.publicTransportClosuresInfo = add(this.publicTransportClosuresInfo, publicTransportClosuresInfo);
    }
    /**
     * Information about public transport closures.
     *
     ...
     */
    @Override
    public void addPublicTransportClosuresInfo(WebContent publicTransportClosuresInfo) {
        this.publicTransportClosuresInfo = add(this.publicTransportClosuresInfo, publicTransportClosuresInfo);
    }
    ...
    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> quarantineGuidelines;
     ...
     */
    @Override
    public <T> List<T> getQuarantineGuidelinesList() {
        return (List<T>) quarantineGuidelines;
    }
     ...
     */
    @Override
    public <T> T getQuarantineGuidelines() {
        return (T) getFirst(quarantineGuidelines);
    }
     ...
     */
    @Override
    public void addQuarantineGuidelines(URL quarantineGuidelines) {
        this.quarantineGuidelines = add(this.quarantineGuidelines, quarantineGuidelines);
    }
    /**
     * Guidelines about quarantine rules, e.g. in the context of a pandemic.
     *
     ...
     */
    @Override
    public void addQuarantineGuidelines(WebContent quarantineGuidelines) {
        this.quarantineGuidelines = add(this.quarantineGuidelines, quarantineGuidelines);
    }

    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> gettingTestedInfo;
     ...
     */
    @Override
    public <T> List<T> getGettingTestedInfoList() {
        return (List<T>) gettingTestedInfo;
    }
     ...
     */
    @Override
    public <T> T getGettingTestedInfo() {
        return (T) getFirst(gettingTestedInfo);
    }
     ...
     */
    @Override
    public void addGettingTestedInfo(URL gettingTestedInfo) {
        this.gettingTestedInfo = add(this.gettingTestedInfo, gettingTestedInfo);
    }
    /**
     * Information about getting tested (for a [[MedicalCondition]]), e.g. in the context of a pandemic.
     *
     ...
     */
    @Override
    public void addGettingTestedInfo(WebContent gettingTestedInfo) {
        this.gettingTestedInfo = add(this.gettingTestedInfo, gettingTestedInfo);
    }

    @JsonLdFieldTypes({ Dataset.class, URL.class, WebContent.class, Observation.class })
    private List<Object> diseaseSpreadStatistics;
     ...
     *
     * @return {@link Dataset} or {@link URL} or {@link WebContent} or {@link Observation}
     * @see <a href="https://pending.schema.org">https://pending.schema.org</a>
     * @see <a href="https://github.com/schemaorg/schemaorg/issues/2490">https://github.com/schemaorg/schemaorg/issues/2490</a>
     */
    @Override
    public <T> List<T> getDiseaseSpreadStatisticsList() {
        return (List<T>) diseaseSpreadStatistics;
    }
     ...
     */
    @Override
    public <T> T getDiseaseSpreadStatistics() {
        return (T) getFirst(diseaseSpreadStatistics);
    }
     ...
     */
    @Override
    public void addDiseaseSpreadStatistics(Dataset diseaseSpreadStatistics) {
        this.diseaseSpreadStatistics = add(this.diseaseSpreadStatistics, diseaseSpreadStatistics);
    }
    /**
     * Statistical information about the spread of a disease, either as [[WebContent]], or
     *   described directly as a [[Dataset]], or the specific [[Observation]]s in the dataset. When a [[WebContent]] URL is
     ...
     */
    @Override
    public void addDiseaseSpreadStatistics(URL diseaseSpreadStatistics) {
        this.diseaseSpreadStatistics = add(this.diseaseSpreadStatistics, diseaseSpreadStatistics);
    }
    /**
     * Statistical information about the spread of a disease, either as [[WebContent]], or
     ...
     */
    @Override
    public void addDiseaseSpreadStatistics(WebContent diseaseSpreadStatistics) {
        this.diseaseSpreadStatistics = add(this.diseaseSpreadStatistics, diseaseSpreadStatistics);
    }
    /**
     * Statistical information about the spread of a disease, either as [[WebContent]], or
     ...
     */
    @Override
    public void addDiseaseSpreadStatistics(Observation diseaseSpreadStatistics) {
        this.diseaseSpreadStatistics = add(this.diseaseSpreadStatistics, diseaseSpreadStatistics);
    }

    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> travelBans;
     ...
     */
    @Override
    public <T> List<T> getTravelBansList() {
        return (List<T>) travelBans;
    }
     ...
     */
    @Override
    public <T> T getTravelBans() {
        return (T) getFirst(travelBans);
    }
     ...
     */
    @Override
    public void addTravelBans(URL travelBans) {
        this.travelBans = add(this.travelBans, travelBans);
    }
    /**
     * Information about travel bans, e.g. in the context of a pandemic.
     *
     ...
     */
    @Override
    public void addTravelBans(WebContent travelBans) {
        this.travelBans = add(this.travelBans, travelBans);
    }

    @JsonLdFieldTypes({ CivicStructure.class, LocalBusiness.class })
    private List<Object> announcementLocation;
     ...
     */
    @Override
    public <T> List<T> getAnnouncementLocationList() {
        return (List<T>) announcementLocation;
    }
     ...
     */
    @Override
    public <T> T getAnnouncementLocation() {
        return (T) getFirst(announcementLocation);
    }
     ...
     */
    @Override
    public void addAnnouncementLocation(CivicStructure announcementLocation) {
        this.announcementLocation = add(this.announcementLocation, announcementLocation);
    }
    /**
     * Indicates a specific [[CivicStructure]] or [[LocalBusiness]] associated with the SpecialAnnouncement. For example, a specific testing facility or business with special opening hours. For a larger geographic region like a quarantine of an entire region, use [[spatialCoverage]].
     *
     ...
     */
    @Override
    public void addAnnouncementLocation(LocalBusiness announcementLocation) {
        this.announcementLocation = add(this.announcementLocation, announcementLocation);
    }

    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> diseasePreventionInfo;
     ...
     */
    @Override
    public <T> List<T> getDiseasePreventionInfoList() {
        return (List<T>) diseasePreventionInfo;
    }
     ...
     */
    @Override
    public <T> T getDiseasePreventionInfo() {
        return (T) getFirst(diseasePreventionInfo);
    }
     ...
     */
    @Override
    public void addDiseasePreventionInfo(URL diseasePreventionInfo) {
        this.diseasePreventionInfo = add(this.diseasePreventionInfo, diseasePreventionInfo);
    }
    /**
     * Information about disease prevention.
     *
     ...
     */
    @Override
    public void addDiseasePreventionInfo(WebContent diseasePreventionInfo) {
        this.diseasePreventionInfo = add(this.diseasePreventionInfo, diseasePreventionInfo);
    }

    @JsonLdFieldTypes({ URL.class, WebContent.class })
    private List<Object> newsUpdatesAndGuidelines;
     ...
     */
    @Override
    public <T> List<T> getNewsUpdatesAndGuidelinesList() {
        return (List<T>) newsUpdatesAndGuidelines;
    }
     ...
     */
    @Override
    public <T> T getNewsUpdatesAndGuidelines() {
        return (T) getFirst(newsUpdatesAndGuidelines);
    }
     ...
     */
    @Override
    public void addNewsUpdatesAndGuidelines(URL newsUpdatesAndGuidelines) {
        this.newsUpdatesAndGuidelines = add(this.newsUpdatesAndGuidelines, newsUpdatesAndGuidelines);
    }
    /**
     * Indicates a page with news updates and guidelines. This could often be (but is not required to be) the main page containing [[SpecialAnnouncement]] markup on a site.
     *
     ...
     */
    @Override
    public void addNewsUpdatesAndGuidelines(WebContent newsUpdatesAndGuidelines) {
        this.newsUpdatesAndGuidelines = add(this.newsUpdatesAndGuidelines, newsUpdatesAndGuidelines);
    }
