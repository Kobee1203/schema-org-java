...
import org.schema.model.HyperToc;
...
public class HyperTocImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements HyperToc {
    ...
    private List<HyperTocEntry> tocEntry;
     ...
     */
    @Override
    public List<HyperTocEntry> getTocEntryList() {
        return tocEntry;
    }
     ...
     */
    @Override
    public void addTocEntry(HyperTocEntry tocEntry) {
        this.tocEntry = add(this.tocEntry, tocEntry);
    }
