...
public class VoteActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements VoteAction {
    ...
    public void addCandidate(Person candidate) {
        this.candidate = add(this.candidate, candidate);
    }

    @JsonLdFieldTypes({ Thing.class, Text.class })
    private List<Object> actionOption;
    ...
    public <T> T getActionOption() {
        return (T) getFirst(actionOption);
    }
    ...
    public void addActionOption(Thing actionOption) {
        this.actionOption = add(this.actionOption, actionOption);
    }
    /**
     * A sub property of object. The options subject to this action.
     *
    ...
    public void addOption(Text option) {
        this.option = add(this.option, option);
    }
    /**
     * A sub property of object. The options subject to this action.
     *
