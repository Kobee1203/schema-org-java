...
public class VoteActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements VoteAction {
     ...
     */
    @Override
    public void setCandidate(Person fCandidate) {
     ...
     */
    @Override
    public void setOption(Object fOption) {
        if(!(fOption instanceof Text) && !(fOption instanceof Thing)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'option': " + fOption);
        }
        this.fOption = fOption;
    }

    private Object fActionOption;
     ...
     */
    @Override
    public void setActionOption(Object fActionOption) {
        if(!(fActionOption instanceof Thing) && !(fActionOption instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'actionOption': " + fActionOption);
        }
