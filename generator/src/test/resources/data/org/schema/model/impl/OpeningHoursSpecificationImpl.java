...
public class OpeningHoursSpecificationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements OpeningHoursSpecification {
     ...
     */
    @Override
    public void setCloses(Time fCloses) {
        this.fCloses = fCloses;
    }
    /**
     * The closing hour of the place or service on the given day(s) of the week.
     *
     ...
     */
    @Override
    public void setCloses(java.time.LocalTime fCloses) {
        this.fCloses = Time.of(fCloses);
    }
     ...
     */
    @Override
    public void setOpens(Time fOpens) {
        this.fOpens = fOpens;
    }
    /**
     * The opening hour of the place or service on the given day(s) of the week.
     ...
     */
    @Override
    public void setOpens(java.time.LocalTime fOpens) {
        this.fOpens = Time.of(fOpens);
    }
