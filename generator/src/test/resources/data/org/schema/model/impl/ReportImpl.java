...
public class ReportImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Report {
    ...
    private List<Text> reportNumber;
     ...
     */
    @Override
    public List<Text> getReportNumberList() {
        return reportNumber;
    }
     ...
     */
    @Override
    public void addReportNumber(Text reportNumber) {
        this.reportNumber = add(this.reportNumber, reportNumber);
    }
