...
public class MessageImpl implements Message {
     ...
     */
    @Override
    public void setBccRecipient(Object fBccRecipient) {
        if(!(fBccRecipient instanceof Person) && !(fBccRecipient instanceof ContactPoint) && !(fBccRecipient instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'bccRecipient': " + fBccRecipient);
        }
        this.fBccRecipient = fBccRecipient;
    }
     ...
     */
    @Override
    public void setDateReceived(DateTime fDateReceived) {
        this.fDateReceived = fDateReceived;
    }

    private Object fCcRecipient;
     ...
     */
    @Override
    public void setCcRecipient(Object fCcRecipient) {
        if(!(fCcRecipient instanceof Person) && !(fCcRecipient instanceof Organization) && !(fCcRecipient instanceof ContactPoint)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'ccRecipient': " + fCcRecipient);
        }
        this.fCcRecipient = fCcRecipient;
    }

    private CreativeWork fMessageAttachment;
     ...
     */
    @Override
    public void setMessageAttachment(CreativeWork fMessageAttachment) {
        this.fMessageAttachment = fMessageAttachment;
    }

    private Object fToRecipient;
     ...
     */
    @Override
    public void setToRecipient(Object fToRecipient) {
        if(!(fToRecipient instanceof ContactPoint) && !(fToRecipient instanceof Person) && !(fToRecipient instanceof Audience) && !(fToRecipient instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'toRecipient': " + fToRecipient);
        }
        this.fToRecipient = fToRecipient;
    }
     ...
     */
    @Override
    public void setDateSent(DateTime fDateSent) {
        this.fDateSent = fDateSent;
    }

    private Object fDateRead;
     ...
     */
    @Override
    public void setDateRead(Object fDateRead) {
        if(!(fDateRead instanceof Date) && !(fDateRead instanceof DateTime)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'dateRead': " + fDateRead);
        }
        this.fDateRead = fDateRead;
    }
     ...
     */
    @Override
    public void setSender(Object fSender) {
        if(!(fSender instanceof Person) && !(fSender instanceof Audience) && !(fSender instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'sender': " + fSender);
        }
