...
public class SuiteImpl implements Suite {
     ...
     */
    @Override
    public void setBed(Object fBed) {
        if(!(fBed instanceof BedDetails) && !(fBed instanceof Text) && !(fBed instanceof BedType)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'bed': " + fBed);
        }
        this.fBed = fBed;
    }
