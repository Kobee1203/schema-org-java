...
public class MobileApplicationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MobileApplication {
    ...
    private List<Text> carrierRequirements;
     ...
     */
    @Override
    public List<Text> getCarrierRequirementsList() {
    ...
    public Text getCarrierRequirements() {
        return getFirst(carrierRequirements);
    }
     ...
     */
    @Override
    public void addCarrierRequirements(Text carrierRequirements) {
        this.carrierRequirements = add(this.carrierRequirements, carrierRequirements);
    }
