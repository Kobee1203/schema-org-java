...
import org.schema.model.models.MusicComposition;
...
public class MusicCompositionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MusicComposition {
    ...
    private List<MusicRecording> recordedAs;
    ...
    public void addRecordedAs(MusicRecording recordedAs) {
        this.recordedAs = add(this.recordedAs, recordedAs);
    }

    private List<Event> firstPerformance;
    ...
    public Event getFirstPerformance() {
        return getFirst(firstPerformance);
    }
    ...
    public void addFirstPerformance(Event firstPerformance) {
        this.firstPerformance = add(this.firstPerformance, firstPerformance);
    }

    private List<CreativeWork> lyrics;
    ...
    public void addLyrics(CreativeWork lyrics) {
        this.lyrics = add(this.lyrics, lyrics);
    }

    private List<MusicComposition> musicArrangement;
    ...
    public MusicComposition getMusicArrangement() {
        return getFirst(musicArrangement);
    }
    ...
    public void addMusicArrangement(MusicComposition musicArrangement) {
        this.musicArrangement = add(this.musicArrangement, musicArrangement);
    }

    private List<Person> lyricist;
    ...
    public void addLyricist(Person lyricist) {
        this.lyricist = add(this.lyricist, lyricist);
    }
    ...
    public void addIswcCode(Text iswcCode) {
        this.iswcCode = add(this.iswcCode, iswcCode);
    }

    private List<Text> musicCompositionForm;
    ...
    public Text getMusicCompositionForm() {
        return getFirst(musicCompositionForm);
    }
    ...
    public void addMusicCompositionForm(Text musicCompositionForm) {
        this.musicCompositionForm = add(this.musicCompositionForm, musicCompositionForm);
    }

    private List<MusicComposition> includedComposition;
    ...
    public MusicComposition getIncludedComposition() {
        return getFirst(includedComposition);
    }
    ...
    public void addIncludedComposition(MusicComposition includedComposition) {
        this.includedComposition = add(this.includedComposition, includedComposition);
    }

    private List<Text> musicalKey;
    ...
    public void addMusicalKey(Text musicalKey) {
        this.musicalKey = add(this.musicalKey, musicalKey);
    }
