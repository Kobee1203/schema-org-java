...
public class ReviewNewsArticleImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ReviewNewsArticle {
     ...
     */
    @Override
    public void setNegativeNotes(Object fNegativeNotes) {
        if(!(fNegativeNotes instanceof ListItem) && !(fNegativeNotes instanceof Text) && !(fNegativeNotes instanceof WebContent) && !(fNegativeNotes instanceof ItemList)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'negativeNotes': " + fNegativeNotes);
        }
     ...
     */
    @Override
    public void setPositiveNotes(Object fPositiveNotes) {
        if(!(fPositiveNotes instanceof WebContent) && !(fPositiveNotes instanceof Text) && !(fPositiveNotes instanceof ListItem) && !(fPositiveNotes instanceof ItemList)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'positiveNotes': " + fPositiveNotes);
        }
     ...
     */
    @Override
    public void setPageStart(Object fPageStart) {
        if(!(fPageStart instanceof Text) && !(fPageStart instanceof Integer)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'pageStart': " + fPageStart);
        }
     ...
     */
    @Override
    public void setPageEnd(Object fPageEnd) {
        if(!(fPageEnd instanceof Text) && !(fPageEnd instanceof Integer)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'pageEnd': " + fPageEnd);
        }
     ...
     */
    @Override
    public void setBackstory(Object fBackstory) {
        if(!(fBackstory instanceof Text) && !(fBackstory instanceof CreativeWork)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'backstory': " + fBackstory);
        }
     ...
     */
    @Override
    public void setSpeakable(Object fSpeakable) {
        if(!(fSpeakable instanceof URL) && !(fSpeakable instanceof SpeakableSpecification)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'speakable': " + fSpeakable);
        }
