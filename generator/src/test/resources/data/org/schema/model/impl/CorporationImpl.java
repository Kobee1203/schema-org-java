...
public class CorporationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Corporation {
    ...
    private List<Text> tickerSymbol;
     ...
     */
    @Override
    public List<Text> getTickerSymbolList() {
        return tickerSymbol;
    }
     ...
     */
    @Override
    public Text getTickerSymbol() {
        return getFirst(tickerSymbol);
    }
     ...
     */
    @Override
    public void addTickerSymbol(Text tickerSymbol) {
        this.tickerSymbol = add(this.tickerSymbol, tickerSymbol);
    }
