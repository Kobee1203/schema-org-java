...
public class FastFoodRestaurantImpl implements FastFoodRestaurant {
     ...
     */
    @Override
    public void setAcceptsReservations(Object fAcceptsReservations) {
        if(!(fAcceptsReservations instanceof Text) && !(fAcceptsReservations instanceof Boolean) && !(fAcceptsReservations instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'acceptsReservations': " + fAcceptsReservations);
        }
     ...
     */
    @Override
    public void setMenu(Object fMenu) {
        if(!(fMenu instanceof URL) && !(fMenu instanceof Menu) && !(fMenu instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'menu': " + fMenu);
        }
        this.fMenu = fMenu;
    }
     ...
     */
    @Override
    public void setHasMenu(Object fHasMenu) {
        if(!(fHasMenu instanceof URL) && !(fHasMenu instanceof Text) && !(fHasMenu instanceof Menu)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'hasMenu': " + fHasMenu);
        }
