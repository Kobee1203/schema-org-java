...
public class FastFoodRestaurantImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements FastFoodRestaurant {
     ...
     */
    @Override
    public void setStarRating(Rating fStarRating) {
        this.fStarRating = fStarRating;
    }

    private Text fServesCuisine;
     ...
     */
    @Override
    public void setServesCuisine(Text fServesCuisine) {
        this.fServesCuisine = fServesCuisine;
    }
    /**
     * The cuisine of the restaurant.
     *
     ...
     */
    @Override
    public void setServesCuisine(java.lang.String fServesCuisine) {
        this.fServesCuisine = Text.of(fServesCuisine);
    }

    private Object fAcceptsReservations;
     ...
     */
    @Override
    public void setAcceptsReservations(Text fAcceptsReservations) {
        this.fAcceptsReservations = fAcceptsReservations;
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     *
     ...
     */
    @Override
    public void setAcceptsReservations(java.lang.String fAcceptsReservations) {
        this.fAcceptsReservations = Text.of(fAcceptsReservations);
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     *
     ...
     */
    @Override
    public void setAcceptsReservations(Boolean fAcceptsReservations) {
        this.fAcceptsReservations = fAcceptsReservations;
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     ...
     */
    @Override
    public void setAcceptsReservations(java.lang.Boolean fAcceptsReservations) {
        this.fAcceptsReservations = Boolean.of(fAcceptsReservations);
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     *
     ...
     */
    @Override
    public void setAcceptsReservations(URL fAcceptsReservations) {
        this.fAcceptsReservations = fAcceptsReservations;
    }
    /**
     * Indicates whether a FoodEstablishment accepts reservations. Values can be Boolean, an URL at which reservations can be made or (for backwards compatibility) the strings ```Yes``` or ```No```.
     ...
     */
    @Override
    public void setAcceptsReservations(java.net.URL fAcceptsReservations) {
        this.fAcceptsReservations = URL.of(fAcceptsReservations);
    }

    private Object fHasMenu;
     ...
     */
    @Override
    public void setHasMenu(URL fHasMenu) {
        this.fHasMenu = fHasMenu;
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     *
     ...
     */
    @Override
    public void setHasMenu(java.net.URL fHasMenu) {
        this.fHasMenu = URL.of(fHasMenu);
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     *
     ...
     */
    @Override
    public void setHasMenu(Text fHasMenu) {
        this.fHasMenu = fHasMenu;
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     ...
     */
    @Override
    public void setHasMenu(java.lang.String fHasMenu) {
        this.fHasMenu = Text.of(fHasMenu);
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     *
     ...
     */
    @Override
    public void setHasMenu(Menu fHasMenu) {
        this.fHasMenu = fHasMenu;
    }

    private Object fMenu;
     ...
     */
    @Override
    public void setMenu(java.net.URL fMenu) {
        this.fMenu = URL.of(fMenu);
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     *
     ...
     */
    @Override
    public void setMenu(Menu fMenu) {
        this.fMenu = fMenu;
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     ...
     */
    @Override
    public void setMenu(Text fMenu) {
        this.fMenu = fMenu;
    }
    /**
     * Either the actual menu as a structured representation, as text, or a URL of the menu.
     ...
     */
    @Override
    public void setMenu(java.lang.String fMenu) {
        this.fMenu = Text.of(fMenu);
    }
