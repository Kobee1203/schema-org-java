...
public class GameServerImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements GameServer {
    ...
    private List<Integer> playersOnline;
     ...
     */
    @Override
    public List<Integer> getPlayersOnlineList() {
     ...
     */
    @Override
    public void addPlayersOnline(Integer playersOnline) {
        this.playersOnline = add(this.playersOnline, playersOnline);
    }

    private List<VideoGame> game;
    ...
    public void addGame(VideoGame game) {
        this.game = add(this.game, game);
    }

    private List<GameServerStatus> serverStatus;
     ...
     */
    @Override
    public void addServerStatus(GameServerStatus serverStatus) {
        this.serverStatus = add(this.serverStatus, serverStatus);
    }
