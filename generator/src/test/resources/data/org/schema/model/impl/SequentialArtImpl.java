...
import org.schema.model.SequentialArt;
 ...
 */
@JsonLdTypeName("SequentialArt")
public class SequentialArtImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SequentialArt {
     ...
     */
    @Override
    public List<Person> getColoristList() {
        return colorist;
    }
     ...
     */
    @Override
    public void addColorist(Person colorist) {
        this.colorist = add(this.colorist, colorist);
    }

    @JsonLdFieldTypes({ Text.class, URL.class })
    private List<Object> artworkSurface;
     ...
     */
    @Override
    public <T> List<T> getArtworkSurfaceList() {
        return (List<T>) artworkSurface;
    }
     ...
     */
    @Override
    public <T> T getArtworkSurface() {
        return (T) getFirst(artworkSurface);
    }
     ...
     */
    @Override
    public void addArtworkSurface(Text artworkSurface) {
        this.artworkSurface = add(this.artworkSurface, artworkSurface);
    }
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     *
     ...
     */
    @Override
    public void addArtworkSurface(URL artworkSurface) {
        this.artworkSurface = add(this.artworkSurface, artworkSurface);
    }
     ...
     */
    @Override
    public List<Person> getArtistList() {
        return artist;
    }
    ...
    public void addArtist(Person artist) {
        this.artist = add(this.artist, artist);
    }

    @JsonLdFieldTypes({ URL.class, Text.class })
    private List<Object> artform;
     ...
     */
    @Override
    public <T> List<T> getArtformList() {
        return (List<T>) artform;
    }
     ...
     */
    @Override
    public <T> T getArtform() {
        return (T) getFirst(artform);
    }
     ...
     */
    @Override
    public void addArtform(URL artform) {
        this.artform = add(this.artform, artform);
    }
    /**
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     *
     ...
     */
    @Override
    public <T> List<T> getSurfaceList() {
        return (List<T>) surface;
    }
     ...
     */
    @Override
    public void addSurface(Text surface) {
        this.surface = add(this.surface, surface);
    }
    /**
     * A material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc.
     *
     ...
     */
    @Override
    public void addSurface(URL surface) {
        this.surface = add(this.surface, surface);
    }
    ...
    private List<Object> artEdition;
     ...
     */
    @Override
    public <T> List<T> getArtEditionList() {
        return (List<T>) artEdition;
    }
     ...
     */
    @Override
    public <T> T getArtEdition() {
        return (T) getFirst(artEdition);
    }
     ...
     */
    @Override
    public void addArtEdition(Text artEdition) {
        this.artEdition = add(this.artEdition, artEdition);
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
     *
     ...
     */
    @Override
    public void addArtEdition(Integer artEdition) {
        this.artEdition = add(this.artEdition, artEdition);
    }
     ...
     */
    @Override
    public List<Person> getLettererList() {
        return letterer;
    }
    ...
    public void addLetterer(Person letterer) {
        this.letterer = add(this.letterer, letterer);
    }

    @JsonLdFieldTypes({ URL.class, Text.class })
    private List<Object> artMedium;
     ...
     */
    @Override
    public <T> List<T> getArtMediumList() {
        return (List<T>) artMedium;
    }
     ...
     */
    @Override
    public <T> T getArtMedium() {
        return (T) getFirst(artMedium);
    }
     ...
     */
    @Override
    public void addArtMedium(URL artMedium) {
        this.artMedium = add(this.artMedium, artMedium);
    }
    /**
     * The material used. (E.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
     *
     ...
     */
    @Override
    public List<Person> getPencilerList() {
        return penciler;
    }
     ...
     */
    @Override
    public void addPenciler(Person penciler) {
        this.penciler = add(this.penciler, penciler);
    }

    private List<Person> inker;
     ...
     */
    @Override
    public List<Person> getInkerList() {
        return inker;
    }
     ...
     */
    @Override
    public void addInker(Person inker) {
        this.inker = add(this.inker, inker);
    }
