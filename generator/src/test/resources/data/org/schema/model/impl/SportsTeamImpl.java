...
public class SportsTeamImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SportsTeam {
     ...
     */
    @Override
    public List<Person> getAthleteList() {
        return athlete;
    }
    ...
    public void addAthlete(Person athlete) {
        this.athlete = add(this.athlete, athlete);
    }
     ...
     */
    @Override
    public List<Person> getCoachList() {
        return coach;
    }
    ...
    public void addCoach(Person coach) {
        this.coach = add(this.coach, coach);
    }

    @JsonLdFieldTypes({ Text.class, URL.class })
    private List<Object> sport;
     ...
     */
    @Override
    public void addSport(Text sport) {
        this.sport = add(this.sport, sport);
    }
    /**
     * A type of sport (e.g. Baseball).
     *
     ...
     */
    @Override
    public void addSport(URL sport) {
        this.sport = add(this.sport, sport);
    }
