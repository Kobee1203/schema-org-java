...
public class ComicIssueImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ComicIssue {
    ...
    private List<Text> variantCover;
     ...
     */
    @Override
    public List<Text> getVariantCoverList() {
        return variantCover;
    }
     ...
     */
    @Override
    public void addVariantCover(Text variantCover) {
        this.variantCover = add(this.variantCover, variantCover);
    }
    ...
    @JsonLdFieldTypes({ Integer.class, Text.class })
    private List<Object> issueNumber;
    ...
    public void addIssueNumber(Integer issueNumber) {
        this.issueNumber = add(this.issueNumber, issueNumber);
    }
    /**
     * Identifies the issue of publication; for example, "iii" or "2".
     *
