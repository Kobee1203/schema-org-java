...
public class ComicIssueImpl implements ComicIssue {
     ...
     */
    @Override
    public void setIssueNumber(Object fIssueNumber) {
        if(!(fIssueNumber instanceof Integer) && !(fIssueNumber instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'issueNumber': " + fIssueNumber);
        }
