...
public class RentalCarReservationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements RentalCarReservation {
     ...
     */
    @Override
    public void setDropoffLocation(Place fDropoffLocation) {
        this.fDropoffLocation = fDropoffLocation;
    }

    private DateTime fDropoffTime;
     ...
     */
    @Override
    public void setDropoffTime(DateTime fDropoffTime) {
        this.fDropoffTime = fDropoffTime;
    }
    /**
     * When a rental car can be dropped off.
     *
     ...
     */
    @Override
    public void setDropoffTime(java.time.LocalDateTime fDropoffTime) {
        this.fDropoffTime = DateTime.of(fDropoffTime);
    }
     ...
     */
    @Override
    public void setPickupTime(java.time.LocalDateTime fPickupTime) {
        this.fPickupTime = DateTime.of(fPickupTime);
    }
