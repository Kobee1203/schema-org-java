...
import org.schema.model.InfectiousDisease;
...
public class InfectiousDiseaseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements InfectiousDisease {
    ...
    private List<Text> infectiousAgent;
     ...
     */
    @Override
    public List<Text> getInfectiousAgentList() {
     ...
     */
    @Override
    public Text getInfectiousAgent() {
        return getFirst(infectiousAgent);
    }
     ...
     */
    @Override
    public void addInfectiousAgent(Text infectiousAgent) {
        this.infectiousAgent = add(this.infectiousAgent, infectiousAgent);
    }

    private List<InfectiousAgentClass> infectiousAgentClass;
    ...
    public InfectiousAgentClass getInfectiousAgentClass() {
        return getFirst(infectiousAgentClass);
    }
     ...
     */
    @Override
    public void addInfectiousAgentClass(InfectiousAgentClass infectiousAgentClass) {
        this.infectiousAgentClass = add(this.infectiousAgentClass, infectiousAgentClass);
    }

    private List<Text> transmissionMethod;
     ...
     */
    @Override
    public List<Text> getTransmissionMethodList() {
     ...
     */
    @Override
    public Text getTransmissionMethod() {
        return getFirst(transmissionMethod);
    }
     ...
     */
    @Override
    public void addTransmissionMethod(Text transmissionMethod) {
        this.transmissionMethod = add(this.transmissionMethod, transmissionMethod);
    }
