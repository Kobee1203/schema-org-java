...
public class DDxElementImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements DDxElement {
    ...
    public MedicalSignOrSymptom getDistinguishingSign() {
        return fDistinguishingSign;
    }

    /**
     * One of a set of signs and symptoms that can be used to distinguish this diagnosis from others in the differential diagnosis.
     *
     * @param fDistinguishingSign MedicalSignOrSymptom value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setDistinguishingSign(MedicalSignOrSymptom fDistinguishingSign) {
        this.fDistinguishingSign = fDistinguishingSign;
    }

    private MedicalCondition fDiagnosis;
     ...
     */
    @Override
    public void setDiagnosis(MedicalCondition fDiagnosis) {
