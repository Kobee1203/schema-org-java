...
public class CompleteDataFeedImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CompleteDataFeed {
     ...
     */
    @Override
    public void setDataFeedElement(Thing fDataFeedElement) {
        this.fDataFeedElement = fDataFeedElement;
    }
    /**
     * An item within in a data feed. Data feeds may have many elements.
     *
     ...
     */
    @Override
    public void setDataFeedElement(DataFeedItem fDataFeedElement) {
        this.fDataFeedElement = fDataFeedElement;
    }
    /**
     * An item within in a data feed. Data feeds may have many elements.
     ...
     */
    @Override
    public void setDataFeedElement(Text fDataFeedElement) {
        this.fDataFeedElement = fDataFeedElement;
    }
    /**
     * An item within in a data feed. Data feeds may have many elements.
     ...
     */
    @Override
    public void setDataFeedElement(java.lang.String fDataFeedElement) {
        this.fDataFeedElement = Text.of(fDataFeedElement);
    }
     ...
     */
    @Override
    public void setCatalog(DataCatalog fCatalog) {
        this.fCatalog = fCatalog;
    }

    private DataCatalog fIncludedDataCatalog;
     ...
     */
    @Override
    public void setIncludedDataCatalog(DataCatalog fIncludedDataCatalog) {
        this.fIncludedDataCatalog = fIncludedDataCatalog;
    }

    private Object fVariableMeasured;
     ...
     */
    @Override
    public void setVariableMeasured(PropertyValue fVariableMeasured) {
        this.fVariableMeasured = fVariableMeasured;
    }
    /**
     * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     *
     ...
     */
    @Override
    public void setVariableMeasured(Text fVariableMeasured) {
        this.fVariableMeasured = fVariableMeasured;
    }
    /**
     * The variableMeasured property can indicate (repeated as necessary) the  variables that are measured in some dataset, either described as text or as pairs of identifier and description using PropertyValue.
     ...
     */
    @Override
    public void setVariableMeasured(java.lang.String fVariableMeasured) {
        this.fVariableMeasured = Text.of(fVariableMeasured);
    }
    ...
    private DateTime fDatasetTimeInterval;
     ...
     */
    @Override
    public void setDatasetTimeInterval(DateTime fDatasetTimeInterval) {
        this.fDatasetTimeInterval = fDatasetTimeInterval;
    }
    /**
     * The range of temporal applicability of a dataset, e.g. for a 2011 census dataset, the year 2011 (in ISO 8601 time interval format).
     *
     ...
     */
    @Override
    public void setDatasetTimeInterval(java.time.LocalDateTime fDatasetTimeInterval) {
        this.fDatasetTimeInterval = DateTime.of(fDatasetTimeInterval);
    }

    private DataDownload fDistribution;
     ...
     */
    @Override
    public void setDistribution(DataDownload fDistribution) {
    ...
    private DataCatalog fIncludedInDataCatalog;
     ...
     */
    @Override
    public void setIncludedInDataCatalog(DataCatalog fIncludedInDataCatalog) {
        this.fIncludedInDataCatalog = fIncludedInDataCatalog;
    }
