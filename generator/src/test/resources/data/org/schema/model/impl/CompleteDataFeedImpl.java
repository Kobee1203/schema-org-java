...
public class CompleteDataFeedImpl implements CompleteDataFeed {
     ...
     */
    @Override
    public void setDataFeedElement(Object fDataFeedElement) {
        if(!(fDataFeedElement instanceof Thing) && !(fDataFeedElement instanceof DataFeedItem) && !(fDataFeedElement instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'dataFeedElement': " + fDataFeedElement);
        }
     ...
     */
    @Override
    public void setVariableMeasured(Object fVariableMeasured) {
        if(!(fVariableMeasured instanceof PropertyValue) && !(fVariableMeasured instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'variableMeasured': " + fVariableMeasured);
        }
