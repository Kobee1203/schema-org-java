...
public class HealthTopicContentImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements HealthTopicContent {
    ...
    private List<HealthAspectEnumeration> hasHealthAspect;
     ...
     */
    @Override
    public List<HealthAspectEnumeration> getHasHealthAspectList() {
    ...
    public HealthAspectEnumeration getHasHealthAspect() {
        return getFirst(hasHealthAspect);
    }
     ...
     */
    @Override
    public void addHasHealthAspect(HealthAspectEnumeration hasHealthAspect) {
        this.hasHealthAspect = add(this.hasHealthAspect, hasHealthAspect);
    }
