...
import org.schema.model.ComicCoverArt;
...
public class ComicCoverArtImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ComicCoverArt {
     ...
     */
    @Override
    public void setLetterer(Person fLetterer) {
        this.fLetterer = fLetterer;
    }

    private Person fColorist;
     ...
     */
    @Override
    public void setColorist(Person fColorist) {
        this.fColorist = fColorist;
    }

    private Person fInker;
     ...
     */
    @Override
    public void setInker(Person fInker) {
        this.fInker = fInker;
    }

    private Person fPenciler;
     ...
     */
    @Override
    public void setPenciler(Person fPenciler) {
        this.fPenciler = fPenciler;
    }

    private Person fArtist;
     ...
     */
    @Override
    public void setArtist(Person fArtist) {
     ...
     */
    @Override
    public void setSurface(URL fSurface) {
     ...
     */
    @Override
    public void setSurface(java.net.URL fSurface) {
        this.fSurface = URL.of(fSurface);
    }
    /**
     * A material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc.
     *
     ...
     */
    @Override
    public void setSurface(Text fSurface) {
        this.fSurface = fSurface;
    }
    /**
     * A material used as a surface in some artwork, e.g. Canvas, Paper, Wood, Board, etc.
     ...
     */
    @Override
    public void setSurface(java.lang.String fSurface) {
        this.fSurface = Text.of(fSurface);
    }

    private Object fArtform;
     ...
     */
    @Override
    public void setArtform(Text fArtform) {
        this.fArtform = fArtform;
    }
    /**
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     *
     ...
     */
    @Override
    public void setArtform(java.lang.String fArtform) {
        this.fArtform = Text.of(fArtform);
    }
    /**
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     *
     ...
     */
    @Override
    public void setArtform(URL fArtform) {
        this.fArtform = fArtform;
    }
    /**
     * e.g. Painting, Drawing, Sculpture, Print, Photograph, Assemblage, Collage, etc.
     ...
     */
    @Override
    public void setArtform(java.net.URL fArtform) {
        this.fArtform = URL.of(fArtform);
    }

    private Object fArtworkSurface;
     ...
     */
    @Override
    public void setArtworkSurface(URL fArtworkSurface) {
        this.fArtworkSurface = fArtworkSurface;
    }
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     *
     ...
     */
    @Override
    public void setArtworkSurface(java.net.URL fArtworkSurface) {
        this.fArtworkSurface = URL.of(fArtworkSurface);
    }
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     *
     ...
     */
    @Override
    public void setArtworkSurface(Text fArtworkSurface) {
        this.fArtworkSurface = fArtworkSurface;
    }
    /**
     * The supporting materials for the artwork, e.g. Canvas, Paper, Wood, Board, etc.
     ...
     */
    @Override
    public void setArtworkSurface(java.lang.String fArtworkSurface) {
        this.fArtworkSurface = Text.of(fArtworkSurface);
    }

    private Object fArtEdition;
     ...
     */
    @Override
    public void setArtEdition(Integer fArtEdition) {
        this.fArtEdition = fArtEdition;
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
     *
     ...
     */
    @Override
    public void setArtEdition(java.lang.Integer fArtEdition) {
        this.fArtEdition = Integer.of(fArtEdition);
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
     *
     ...
     */
    @Override
    public void setArtEdition(Text fArtEdition) {
        this.fArtEdition = fArtEdition;
    }
    /**
     * The number of copies when multiple copies of a piece of artwork are produced - e.g. for a limited edition of 20 prints, 'artEdition' refers to the total number of copies (in this example "20").
     ...
     */
    @Override
    public void setArtEdition(java.lang.String fArtEdition) {
        this.fArtEdition = Text.of(fArtEdition);
    }
     ...
     */
    @Override
    public void setArtMedium(URL fArtMedium) {
        this.fArtMedium = fArtMedium;
    }
    /**
     * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
     *
     ...
     */
    @Override
    public void setArtMedium(java.net.URL fArtMedium) {
        this.fArtMedium = URL.of(fArtMedium);
    }
    /**
     * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
     *
     ...
     */
    @Override
    public void setArtMedium(Text fArtMedium) {
        this.fArtMedium = fArtMedium;
    }
    /**
     * The material used. (e.g. Oil, Watercolour, Acrylic, Linoprint, Marble, Cyanotype, Digital, Lithograph, DryPoint, Intaglio, Pastel, Woodcut, Pencil, Mixed Media, etc.)
     ...
     */
    @Override
    public void setArtMedium(java.lang.String fArtMedium) {
        this.fArtMedium = Text.of(fArtMedium);
    }
}
