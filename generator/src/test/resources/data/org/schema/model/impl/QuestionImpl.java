...
public class QuestionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Question {
    ...
    private List<Text> eduQuestionType;
     ...
     */
    @Override
    public List<Text> getEduQuestionTypeList() {
     ...
     */
    @Override
    public Text getEduQuestionType() {
        return getFirst(eduQuestionType);
    }
     ...
     */
    @Override
    public void addEduQuestionType(Text eduQuestionType) {
        this.eduQuestionType = add(this.eduQuestionType, eduQuestionType);
    }
     ...
     */
    @Override
    public void addAnswerCount(Integer answerCount) {
        this.answerCount = add(this.answerCount, answerCount);
    }

    @JsonLdFieldTypes({ ItemList.class, Answer.class })
    private List<Object> suggestedAnswer;
     ...
     */
    @Override
    public <T> List<T> getSuggestedAnswerList() {
        return (List<T>) suggestedAnswer;
    }
     ...
     */
    @Override
    public <T> T getSuggestedAnswer() {
        return (T) getFirst(suggestedAnswer);
    }
     ...
     */
    @Override
    public void addSuggestedAnswer(ItemList suggestedAnswer) {
        this.suggestedAnswer = add(this.suggestedAnswer, suggestedAnswer);
    }
    /**
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     *
     ...
     */
    @Override
    public void addSuggestedAnswer(Answer suggestedAnswer) {
        this.suggestedAnswer = add(this.suggestedAnswer, suggestedAnswer);
    }

    @JsonLdFieldTypes({ Answer.class, ItemList.class })
    private List<Object> acceptedAnswer;
     ...
     */
    @Override
    public <T> List<T> getAcceptedAnswerList() {
        return (List<T>) acceptedAnswer;
    }
     ...
     */
    @Override
    public <T> T getAcceptedAnswer() {
        return (T) getFirst(acceptedAnswer);
    }
    ...
    public void addAcceptedAnswer(Answer acceptedAnswer) {
        this.acceptedAnswer = add(this.acceptedAnswer, acceptedAnswer);
    }
    /**
     * The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     *
     ...
     */
    @Override
    public void addAcceptedAnswer(ItemList acceptedAnswer) {
        this.acceptedAnswer = add(this.acceptedAnswer, acceptedAnswer);
    }
