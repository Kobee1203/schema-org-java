...
public class QuestionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Question {
     ...
     */
    @Override
    public void setSuggestedAnswer(ItemList fSuggestedAnswer) {
        this.fSuggestedAnswer = fSuggestedAnswer;
    }
    /**
     * An answer (possibly one of several, possibly incorrect) to a Question, e.g. on a Question/Answer site.
     *
     ...
     */
    @Override
    public void setSuggestedAnswer(Answer fSuggestedAnswer) {
        this.fSuggestedAnswer = fSuggestedAnswer;
    }

    private Object fAcceptedAnswer;
     ...
     */
    @Override
    public void setAcceptedAnswer(Answer fAcceptedAnswer) {
        this.fAcceptedAnswer = fAcceptedAnswer;
    }
    /**
     * The answer(s) that has been accepted as best, typically on a Question/Answer site. Sites vary in their selection mechanisms, e.g. drawing on community opinion and/or the view of the Question author.
     *
     ...
     */
    @Override
    public void setAcceptedAnswer(ItemList fAcceptedAnswer) {
        this.fAcceptedAnswer = fAcceptedAnswer;
    }

    private Integer fAnswerCount;
     ...
     */
    @Override
    public void setAnswerCount(Integer fAnswerCount) {
        this.fAnswerCount = fAnswerCount;
    }
    /**
     * The number of answers this question has received.
     *
     ...
     */
    @Override
    public void setAnswerCount(java.lang.Integer fAnswerCount) {
        this.fAnswerCount = Integer.of(fAnswerCount);
    }
     ...
     */
    @Override
    public void setEduQuestionType(Text fEduQuestionType) {
        this.fEduQuestionType = fEduQuestionType;
    }
    /**
     * For questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: "Multiple choice", "Open ended", "Flashcard".
     *
     ...
     */
    @Override
    public void setEduQuestionType(java.lang.String fEduQuestionType) {
        this.fEduQuestionType = Text.of(fEduQuestionType);
    }
     ...
     * The parent of a question, answer or item in general.
     *
     * @param fParentItem Comment value to set.
     */
    @Override
    public void setParentItem(Comment fParentItem) {
        this.fParentItem = fParentItem;
    }

    private Integer fDownvoteCount;
    ...
    public Integer getDownvoteCount() {
        return fDownvoteCount;
    }

    /**
     * The number of downvotes this question, answer or comment has received from the community.
     *
     * @param fDownvoteCount Integer value to set.
     */
    @Override
    public void setDownvoteCount(Integer fDownvoteCount) {
        this.fDownvoteCount = fDownvoteCount;
    }
    /**
     * The number of downvotes this question, answer or comment has received from the community.
     *
     * @param fDownvoteCount java.lang.Integer value to set.
     */
    @Override
    public void setDownvoteCount(java.lang.Integer fDownvoteCount) {
        this.fDownvoteCount = Integer.of(fDownvoteCount);
    }

    private Integer fUpvoteCount;
     ...
     * The number of upvotes this question, answer or comment has received from the community.
     *
     * @param fUpvoteCount Integer value to set.
     */
    @Override
    public void setUpvoteCount(Integer fUpvoteCount) {
        this.fUpvoteCount = fUpvoteCount;
    }
    /**
     * The number of upvotes this question, answer or comment has received from the community.
     *
     * @param fUpvoteCount java.lang.Integer value to set.
     */
    @Override
    public void setUpvoteCount(java.lang.Integer fUpvoteCount) {
        this.fUpvoteCount = Integer.of(fUpvoteCount);
    }
