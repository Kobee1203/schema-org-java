...
public class QuestionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Question {
     ...
     */
    @Override
    public void setSuggestedAnswer(Object fSuggestedAnswer) {
        if(!(fSuggestedAnswer instanceof ItemList) && !(fSuggestedAnswer instanceof Answer)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'suggestedAnswer': " + fSuggestedAnswer);
        }
     ...
     */
    @Override
    public void setAcceptedAnswer(Object fAcceptedAnswer) {
        if(!(fAcceptedAnswer instanceof Answer) && !(fAcceptedAnswer instanceof ItemList)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'acceptedAnswer': " + fAcceptedAnswer);
        }
