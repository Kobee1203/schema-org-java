...
public class MusicReleaseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MusicRelease {
     ...
     */
    @Override
    public void setCreditedTo(Person fCreditedTo) {
     ...
     */
    @Override
    public void setCreditedTo(Organization fCreditedTo) {
        this.fCreditedTo = fCreditedTo;
    }
     ...
     */
    @Override
    public void setCatalogNumber(java.lang.String fCatalogNumber) {
        this.fCatalogNumber = Text.of(fCatalogNumber);
    }
     ...
     */
    @Override
    public void setNumTracks(java.lang.Integer fNumTracks) {
        this.fNumTracks = Integer.of(fNumTracks);
    }
     ...
     */
    @Override
    public void setTrack(ItemList fTrack) {
        this.fTrack = fTrack;
    }
    /**
     * A music recording (track)&#x2014;usually a single song. If an ItemList is given, the list should contain items of type MusicRecording.
     ...
     */
    @Override
    public void setTrack(MusicRecording fTrack) {
        this.fTrack = fTrack;
    }
