...
public class FlightReservationImpl implements FlightReservation {
     ...
     */
    @Override
    public void setPassengerPriorityStatus(Object fPassengerPriorityStatus) {
        if(!(fPassengerPriorityStatus instanceof QualitativeValue) && !(fPassengerPriorityStatus instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'passengerPriorityStatus': " + fPassengerPriorityStatus);
        }
