...
public class ProductModelImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ProductModel {
     ...
     * A pointer from a newer variant of a product  to its previous, often discontinued predecessor.
     *
     * @param fSuccessorOf ProductModel value to set.
     * @see <a href="http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_GoodRelationsTerms">http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_GoodRelationsTerms</a>
     */
    @Override
    public void setSuccessorOf(ProductModel fSuccessorOf) {
        this.fSuccessorOf = fSuccessorOf;
    }

    private ProductModel fPredecessorOf;
    ...
    public ProductModel getPredecessorOf() {
        return fPredecessorOf;
    }

    /**
     * A pointer from a previous, often discontinued variant of the product to its newer variant.
     *
     * @param fPredecessorOf ProductModel value to set.
     * @see <a href="http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_GoodRelationsTerms">http://www.w3.org/wiki/WebSchemas/SchemaDotOrgSources#source_GoodRelationsTerms</a>
     */
    @Override
    public void setPredecessorOf(ProductModel fPredecessorOf) {
        this.fPredecessorOf = fPredecessorOf;
    }
