...
import org.schema.model.TechArticle;
import org.schema.model.APIReference;
...
public class APIReferenceImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements APIReference {
     ...
     */
    @Override
    public void setAssembly(Text fAssembly) {
     ...
     */
    @Override
    public void setAssembly(java.lang.String fAssembly) {
        this.fAssembly = Text.of(fAssembly);
    }

    private Text fTargetPlatform;
     ...
     */
    @Override
    public Text getTargetPlatform() {
        return fTargetPlatform;
    }
     ...
     */
    @Override
    public void setTargetPlatform(Text fTargetPlatform) {
        this.fTargetPlatform = fTargetPlatform;
    }
    /**
     * Type of app development: phone, Metro style, desktop, XBox, etc.
     *
     ...
     */
    @Override
    public void setTargetPlatform(java.lang.String fTargetPlatform) {
        this.fTargetPlatform = Text.of(fTargetPlatform);
    }

    private Text fExecutableLibraryName;
     ...
     */
    @Override
    public Text getExecutableLibraryName() {
        return fExecutableLibraryName;
    }
     ...
     */
    @Override
    public void setExecutableLibraryName(Text fExecutableLibraryName) {
        this.fExecutableLibraryName = fExecutableLibraryName;
    }
    /**
     * Library file name e.g., mscorlib.dll, system.web.dll.
     *
     ...
     */
    @Override
    public void setExecutableLibraryName(java.lang.String fExecutableLibraryName) {
        this.fExecutableLibraryName = Text.of(fExecutableLibraryName);
    }

    private Text fProgrammingModel;
     ...
     */
    @Override
    public Text getProgrammingModel() {
        return fProgrammingModel;
    }
     ...
     */
    @Override
    public void setProgrammingModel(Text fProgrammingModel) {
        this.fProgrammingModel = fProgrammingModel;
    }
    /**
     * Indicates whether API is managed or unmanaged.
     *
     ...
     */
    @Override
    public void setProgrammingModel(java.lang.String fProgrammingModel) {
        this.fProgrammingModel = Text.of(fProgrammingModel);
    }

    private Text fAssemblyVersion;
     ...
     */
    @Override
    public Text getAssemblyVersion() {
     ...
     */
    @Override
    public void setAssemblyVersion(Text fAssemblyVersion) {
        this.fAssemblyVersion = fAssemblyVersion;
    }
    /**
     * Associated product/technology version. e.g., .NET Framework 4.5.
     *
     ...
     */
    @Override
    public void setAssemblyVersion(java.lang.String fAssemblyVersion) {
        this.fAssemblyVersion = Text.of(fAssemblyVersion);
    }
     ...
     */
    @Override
    public void setDependencies(Text fDependencies) {
     ...
     */
    @Override
    public void setDependencies(java.lang.String fDependencies) {
        this.fDependencies = Text.of(fDependencies);
    }

    private Text fProficiencyLevel;
     ...
     */
    @Override
    public Text getProficiencyLevel() {
     ...
     */
    @Override
    public void setProficiencyLevel(Text fProficiencyLevel) {
        this.fProficiencyLevel = fProficiencyLevel;
    }
    /**
     * Proficiency needed for this content; expected values: 'Beginner', 'Expert'.
     *
     ...
     */
    @Override
    public void setProficiencyLevel(java.lang.String fProficiencyLevel) {
        this.fProficiencyLevel = Text.of(fProficiencyLevel);
    }
     ...
     */
    @Override
    public void setPageStart(Text fPageStart) {
     ...
     */
    @Override
    public void setPageStart(java.lang.String fPageStart) {
        this.fPageStart = Text.of(fPageStart);
    }
    /**
     * The page on which the work starts; for example "135" or "xiii".
     *
     ...
     */
    @Override
    public void setPageStart(Integer fPageStart) {
        this.fPageStart = fPageStart;
    }
    /**
     * The page on which the work starts; for example "135" or "xiii".
     ...
     */
    @Override
    public void setPageStart(java.lang.Integer fPageStart) {
        this.fPageStart = Integer.of(fPageStart);
    }

    private Text fArticleSection;
     ...
     */
    @Override
    public void setArticleSection(Text fArticleSection) {
        this.fArticleSection = fArticleSection;
    }
    /**
     * Articles may belong to one or more 'sections' in a magazine or newspaper, such as Sports, Lifestyle, etc.
     *
     ...
     */
    @Override
    public void setArticleSection(java.lang.String fArticleSection) {
        this.fArticleSection = Text.of(fArticleSection);
    }

    private Object fPageEnd;
     ...
     */
    @Override
    public void setPageEnd(Text fPageEnd) {
        this.fPageEnd = fPageEnd;
    }
    /**
     * The page on which the work ends; for example "138" or "xvi".
     *
     ...
     */
    @Override
    public void setPageEnd(java.lang.String fPageEnd) {
        this.fPageEnd = Text.of(fPageEnd);
    }
    /**
     * The page on which the work ends; for example "138" or "xvi".
     *
     ...
     */
    @Override
    public void setPageEnd(Integer fPageEnd) {
        this.fPageEnd = fPageEnd;
    }
    /**
     * The page on which the work ends; for example "138" or "xvi".
     ...
     */
    @Override
    public void setPageEnd(java.lang.Integer fPageEnd) {
        this.fPageEnd = Integer.of(fPageEnd);
    }

    private Object fBackstory;
     ...
     */
    @Override
    public void setBackstory(Text fBackstory) {
        this.fBackstory = fBackstory;
    }
    /**
     * For an [[Article]], typically a [[NewsArticle]], the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc.
     *
     ...
     */
    @Override
    public void setBackstory(java.lang.String fBackstory) {
        this.fBackstory = Text.of(fBackstory);
    }
    /**
     * For an [[Article]], typically a [[NewsArticle]], the backstory property provides a textual summary giving a brief explanation of why and how an article was created. In a journalistic setting this could include information about reporting process, methods, interviews, data sources, etc.
     *
     ...
     */
    @Override
    public void setBackstory(CreativeWork fBackstory) {
        this.fBackstory = fBackstory;
    }

    private Integer fWordCount;
     ...
     */
    @Override
    public void setWordCount(Integer fWordCount) {
        this.fWordCount = fWordCount;
    }
    /**
     * The number of words in the text of the Article.
     *
     ...
     */
    @Override
    public void setWordCount(java.lang.Integer fWordCount) {
        this.fWordCount = Integer.of(fWordCount);
    }

    private Text fArticleBody;
     ...
     */
    @Override
    public void setArticleBody(Text fArticleBody) {
        this.fArticleBody = fArticleBody;
    }
    /**
     * The actual body of the article.
     *
     ...
     */
    @Override
    public void setArticleBody(java.lang.String fArticleBody) {
        this.fArticleBody = Text.of(fArticleBody);
    }

    private Object fSpeakable;
     ...
     */
    @Override
    public void setSpeakable(URL fSpeakable) {
        this.fSpeakable = fSpeakable;
    }
    /**
     * Indicates sections of a Web page that are particularly 'speakable' in the sense of being highlighted as being especially appropriate for text-to-speech conversion. Other sections of a page may also be usefully spoken in particular circumstances; the 'speakable' property serves to indicate the parts most likely to be generally useful for speech.
     * 
     ...
     */
    @Override
    public void setSpeakable(java.net.URL fSpeakable) {
        this.fSpeakable = URL.of(fSpeakable);
    }
    /**
     * Indicates sections of a Web page that are particularly 'speakable' in the sense of being highlighted as being especially appropriate for text-to-speech conversion. Other sections of a page may also be usefully spoken in particular circumstances; the 'speakable' property serves to indicate the parts most likely to be generally useful for speech.
     * 
     ...
     */
    @Override
    public void setSpeakable(SpeakableSpecification fSpeakable) {
        this.fSpeakable = fSpeakable;
    }

    private Text fPagination;
     ...
     */
    @Override
    public void setPagination(Text fPagination) {
        this.fPagination = fPagination;
    }
    /**
     * Any description of pages that is not separated into pageStart and pageEnd; for example, "1-6, 9, 55" or "10-12, 46-49".
     *
     ...
     */
    @Override
    public void setPagination(java.lang.String fPagination) {
        this.fPagination = Text.of(fPagination);
    }
