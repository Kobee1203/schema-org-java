...
public class AirlineImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Airline {
     ...
     */
    @Override
    public List<Text> getIataCodeList() {
        return iataCode;
    }
     ...
     */
    @Override
    public Text getIataCode() {
        return getFirst(iataCode);
    }
     ...
     */
    @Override
    public void addIataCode(Text iataCode) {
        this.iataCode = add(this.iataCode, iataCode);
    }
