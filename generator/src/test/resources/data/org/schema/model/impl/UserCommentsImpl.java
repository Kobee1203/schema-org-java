...
import org.schema.model.UserComments;
...
public class UserCommentsImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements UserComments {
     ...
     */
    @Override
    public List<Text> getCommentTextList() {
        return commentText;
    }
     ...
     */
    @Override
    public void addCommentText(Text commentText) {
        this.commentText = add(this.commentText, commentText);
    }

    private List<URL> replyToUrl;
     ...
     */
    @Override
    public List<URL> getReplyToUrlList() {
        return replyToUrl;
    }
     ...
     */
    @Override
    public void addReplyToUrl(URL replyToUrl) {
        this.replyToUrl = add(this.replyToUrl, replyToUrl);
    }
    ...
    private List<Object> commentTime;
     ...
     */
    @Override
    public <T> List<T> getCommentTimeList() {
        return (List<T>) commentTime;
    }
     ...
     */
    @Override
    public void addCommentTime(DateTime commentTime) {
        this.commentTime = add(this.commentTime, commentTime);
    }
    /**
     * The time at which the UserComment was made.
     *
     ...
     */
    @Override
    public void addCommentTime(Date commentTime) {
        this.commentTime = add(this.commentTime, commentTime);
    }

    private List<CreativeWork> discusses;
     ...
     */
    @Override
    public List<CreativeWork> getDiscussesList() {
        return discusses;
    }
     ...
     */
    @Override
    public void addDiscusses(CreativeWork discusses) {
        this.discusses = add(this.discusses, discusses);
    }
