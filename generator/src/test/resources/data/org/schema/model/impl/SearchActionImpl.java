...
public class SearchActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SearchAction {
     ...
     * A sub property of instrument. The query used on this action.
     *
     * @param fQuery Text value to set.
     */
    @Override
    public void setQuery(Text fQuery) {
        this.fQuery = fQuery;
    }
    /**
     * A sub property of instrument. The query used on this action.
     *
     * @param fQuery java.lang.String value to set.
     */
    @Override
    public void setQuery(java.lang.String fQuery) {
        this.fQuery = Text.of(fQuery);
    }
