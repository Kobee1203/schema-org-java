...
public class MenuSectionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MenuSection {
    ...
    public MenuSection getHasMenuSection() {
        return fHasMenuSection;
    }

    /**
     * A subgrouping of the menu (by dishes, course, serving time period, etc.).
     *
     * @param fHasMenuSection MenuSection value to set.
     */
    @Override
    public void setHasMenuSection(MenuSection fHasMenuSection) {
        this.fHasMenuSection = fHasMenuSection;
    }

    private MenuItem fHasMenuItem;
     ...
     * A food or drink item contained in a menu or menu section.
     *
     * @param fHasMenuItem MenuItem value to set.
     */
    @Override
    public void setHasMenuItem(MenuItem fHasMenuItem) {
        this.fHasMenuItem = fHasMenuItem;
    }
