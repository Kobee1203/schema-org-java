...
public class PlayGameActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements PlayGameAction {
    ...
    @JsonLdFieldTypes({ Text.class, GameAvailabilityEnumeration.class })
    private List<Object> gameAvailabilityType;
     ...
     */
    @Override
    public <T> List<T> getGameAvailabilityTypeList() {
        return (List<T>) gameAvailabilityType;
    }
     ...
     */
    @Override
    public <T> T getGameAvailabilityType() {
        return (T) getFirst(gameAvailabilityType);
    }
     ...
     */
    @Override
    public void addGameAvailabilityType(Text gameAvailabilityType) {
        this.gameAvailabilityType = add(this.gameAvailabilityType, gameAvailabilityType);
    }
    /**
     * Indicates the availability type of the game content associated with this action, such as whether it is a full version or a demo.
     *
     ...
     */
    @Override
    public void addGameAvailabilityType(GameAvailabilityEnumeration gameAvailabilityType) {
        this.gameAvailabilityType = add(this.gameAvailabilityType, gameAvailabilityType);
    }

    private List<ActionAccessSpecification> actionAccessibilityRequirement;
     ...
     */
    @Override
    public List<ActionAccessSpecification> getActionAccessibilityRequirementList() {
    ...
    public ActionAccessSpecification getActionAccessibilityRequirement() {
        return getFirst(actionAccessibilityRequirement);
    }
     ...
     */
    @Override
    public void addActionAccessibilityRequirement(ActionAccessSpecification actionAccessibilityRequirement) {
        this.actionAccessibilityRequirement = add(this.actionAccessibilityRequirement, actionAccessibilityRequirement);
    }
     ...
     *
     * @return {@link EntryPoint} or {@link URL}
     */
    @Override
