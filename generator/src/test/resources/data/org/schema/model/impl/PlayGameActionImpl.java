...
public class PlayGameActionImpl implements PlayGameAction {
     ...
     */
    @Override
    public void setGameAvailabilityType(Object fGameAvailabilityType) {
        if(!(fGameAvailabilityType instanceof GameAvailabilityEnumeration) && !(fGameAvailabilityType instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'gameAvailabilityType': " + fGameAvailabilityType);
        }
