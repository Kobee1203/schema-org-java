...
public class WebApplicationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements WebApplication {
    ...
    private List<Text> browserRequirements;
     ...
     */
    @Override
    public List<Text> getBrowserRequirementsList() {
     ...
     */
    @Override
    public Text getBrowserRequirements() {
        return getFirst(browserRequirements);
    }
     ...
     */
    @Override
    public void addBrowserRequirements(Text browserRequirements) {
        this.browserRequirements = add(this.browserRequirements, browserRequirements);
    }
