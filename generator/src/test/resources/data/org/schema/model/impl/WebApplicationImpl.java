...
public class WebApplicationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements WebApplication {
     ...
     */
    @Override
    public void setBrowserRequirements(Text fBrowserRequirements) {
        this.fBrowserRequirements = fBrowserRequirements;
    }
    /**
     * Specifies browser requirements in human-readable text. For example, 'requires HTML5 support'.
     *
     ...
     */
    @Override
    public void setBrowserRequirements(java.lang.String fBrowserRequirements) {
        this.fBrowserRequirements = Text.of(fBrowserRequirements);
    }
