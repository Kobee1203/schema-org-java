...
public class EndorseActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements EndorseAction {
     ...
     */
    @Override
    public <T> List<T> getEndorseeList() {
        return (List<T>) endorsee;
    }
     ...
     */
    @Override
    public <T> T getEndorsee() {
        return (T) getFirst(endorsee);
    }
     ...
     */
    @Override
    public void addEndorsee(Person endorsee) {
        this.endorsee = add(this.endorsee, endorsee);
    }
    /**
     * A sub property of participant. The person/organization being supported.
     *
     ...
     */
    @Override
    public void addEndorsee(Organization endorsee) {
        this.endorsee = add(this.endorsee, endorsee);
    }
