...
public class EndorseActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements EndorseAction {
     ...
     */
    @Override
    public void setEndorsee(Object fEndorsee) {
        if(!(fEndorsee instanceof Person) && !(fEndorsee instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'endorsee': " + fEndorsee);
        }
        this.fEndorsee = fEndorsee;
    }
