...
public class MedicalConditionStageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalConditionStage {
     ...
     */
    @Override
    public void setSubStageSuffix(Text fSubStageSuffix) {
        this.fSubStageSuffix = fSubStageSuffix;
    }
    /**
     * The substage, e.g. 'a' for Stage IIIa.
     *
     ...
     */
    @Override
    public void setSubStageSuffix(java.lang.String fSubStageSuffix) {
        this.fSubStageSuffix = Text.of(fSubStageSuffix);
    }

    private Number fStageAsNumber;
     ...
     */
    @Override
    public void setStageAsNumber(Number fStageAsNumber) {
        this.fStageAsNumber = fStageAsNumber;
    }
    /**
     * The stage represented as a number, e.g. 3.
     *
     ...
     */
    @Override
    public void setStageAsNumber(java.lang.Number fStageAsNumber) {
        this.fStageAsNumber = Number.of(fStageAsNumber);
    }
