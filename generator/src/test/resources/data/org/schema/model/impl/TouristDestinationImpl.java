...
public class TouristDestinationImpl implements TouristDestination {
     ...
     */
    @Override
    public void setTouristType(Object fTouristType) {
        if(!(fTouristType instanceof Audience) && !(fTouristType instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'touristType': " + fTouristType);
        }
        this.fTouristType = fTouristType;
    }

    private TouristAttraction fIncludesAttraction;
     ...
     */
    @Override
    public void setIncludesAttraction(TouristAttraction fIncludesAttraction) {
        this.fIncludesAttraction = fIncludesAttraction;
    }
