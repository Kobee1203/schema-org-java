...
public class TouristDestinationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements TouristDestination {
    ...
    private List<TouristAttraction> includesAttraction;
     ...
     */
    @Override
    public List<TouristAttraction> getIncludesAttractionList() {
    ...
    public TouristAttraction getIncludesAttraction() {
        return getFirst(includesAttraction);
    }
     ...
     */
    @Override
    public void addIncludesAttraction(TouristAttraction includesAttraction) {
        this.includesAttraction = add(this.includesAttraction, includesAttraction);
    }
