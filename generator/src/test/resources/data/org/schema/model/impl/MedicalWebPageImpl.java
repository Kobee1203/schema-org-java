...
public class MedicalWebPageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalWebPage {
     ...
     * An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc.
     *
     * @param fAspect Text value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setAspect(Text fAspect) {
        this.fAspect = fAspect;
    }
    /**
     * An aspect of medical practice that is considered on the page, such as 'diagnosis', 'treatment', 'causes', 'prognosis', 'etiology', 'epidemiology', etc.
     *
     * @param fAspect java.lang.String value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setAspect(java.lang.String fAspect) {
        this.fAspect = Text.of(fAspect);
    }

    private Object fMedicalAudience;
    ...
    public <T> T getMedicalAudience() {
        return (T) fMedicalAudience;
    }

    /**
     * Medical audience for page.
     *
     * @param fMedicalAudience MedicalAudienceType value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setMedicalAudience(MedicalAudienceType fMedicalAudience) {
        this.fMedicalAudience = fMedicalAudience;
    }
    /**
     * Medical audience for page.
     *
     * @param fMedicalAudience MedicalAudience value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
    public void setMedicalAudience(MedicalAudience fMedicalAudience) {
        this.fMedicalAudience = fMedicalAudience;
    }
     ...
     */
    @Override
    public void setLastReviewed(Date fLastReviewed) {
        this.fLastReviewed = fLastReviewed;
    }
    /**
     * Date on which the content on this web page was last reviewed for accuracy and/or completeness.
     *
     ...
     */
    @Override
    public void setLastReviewed(java.time.LocalDate fLastReviewed) {
        this.fLastReviewed = Date.of(fLastReviewed);
    }
     ...
     */
    @Override
    public void setSpecialty(Specialty fSpecialty) {
        this.fSpecialty = fSpecialty;
    }

    private ImageObject fPrimaryImageOfPage;
     ...
     */
    @Override
    public void setPrimaryImageOfPage(ImageObject fPrimaryImageOfPage) {
        this.fPrimaryImageOfPage = fPrimaryImageOfPage;
    }

    private URL fSignificantLink;
     ...
     */
    @Override
    public void setSignificantLink(URL fSignificantLink) {
        this.fSignificantLink = fSignificantLink;
    }
    /**
     * One of the more significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
     *
     ...
     */
    @Override
    public void setSignificantLink(java.net.URL fSignificantLink) {
        this.fSignificantLink = URL.of(fSignificantLink);
    }

    private Object fReviewedBy;
     ...
     */
    @Override
    public void setReviewedBy(Organization fReviewedBy) {
        this.fReviewedBy = fReviewedBy;
    }
    /**
     * People or organizations that have reviewed the content on this web page for accuracy and/or completeness.
     *
     ...
     */
    @Override
    public void setReviewedBy(Person fReviewedBy) {
        this.fReviewedBy = fReviewedBy;
    }

    private WebPageElement fMainContentOfPage;
     ...
     */
    @Override
    public void setMainContentOfPage(WebPageElement fMainContentOfPage) {
        this.fMainContentOfPage = fMainContentOfPage;
    }

    private URL fRelatedLink;
     ...
     */
    @Override
    public void setRelatedLink(URL fRelatedLink) {
        this.fRelatedLink = fRelatedLink;
    }
    /**
     * A link related to this web page, for example to other related web pages.
     *
     ...
     */
    @Override
    public void setRelatedLink(java.net.URL fRelatedLink) {
        this.fRelatedLink = URL.of(fRelatedLink);
    }
     ...
     */
    @Override
    public void setBreadcrumb(BreadcrumbList fBreadcrumb) {
        this.fBreadcrumb = fBreadcrumb;
    }
    /**
     * A set of links that can help a user understand and navigate a website hierarchy.
     *
     ...
     */
    @Override
    public void setBreadcrumb(Text fBreadcrumb) {
        this.fBreadcrumb = fBreadcrumb;
    }
    /**
     * A set of links that can help a user understand and navigate a website hierarchy.
     ...
     */
    @Override
    public void setBreadcrumb(java.lang.String fBreadcrumb) {
        this.fBreadcrumb = Text.of(fBreadcrumb);
    }

    private URL fSignificantLinks;
     ...
     */
    @Override
    public void setSignificantLinks(URL fSignificantLinks) {
        this.fSignificantLinks = fSignificantLinks;
    }
    /**
     * The most significant URLs on the page. Typically, these are the non-navigation links that are clicked on the most.
     *
     ...
     */
    @Override
    public void setSignificantLinks(java.net.URL fSignificantLinks) {
        this.fSignificantLinks = URL.of(fSignificantLinks);
    }
