...
public class MedicalWebPageImpl implements MedicalWebPage {
     ...
     */
    @Override
    public void setMedicalAudience(Object fMedicalAudience) {
        if(!(fMedicalAudience instanceof MedicalAudienceType) && !(fMedicalAudience instanceof MedicalAudience)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'medicalAudience': " + fMedicalAudience);
        }
     ...
     */
    @Override
    public void setReviewedBy(Object fReviewedBy) {
        if(!(fReviewedBy instanceof Organization) && !(fReviewedBy instanceof Person)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'reviewedBy': " + fReviewedBy);
        }
     ...
     */
    @Override
    public void setBreadcrumb(Object fBreadcrumb) {
        if(!(fBreadcrumb instanceof BreadcrumbList) && !(fBreadcrumb instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'breadcrumb': " + fBreadcrumb);
        }
