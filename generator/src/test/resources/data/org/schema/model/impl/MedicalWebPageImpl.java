...
public class MedicalWebPageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalWebPage {
    ...
    @JsonLdFieldTypes({ MedicalAudience.class, MedicalAudienceType.class })
    private List<Object> medicalAudience;
     ...
     */
    @Override
    public <T> List<T> getMedicalAudienceList() {
        return (List<T>) medicalAudience;
    }
     ...
     */
    @Override
    public <T> T getMedicalAudience() {
        return (T) getFirst(medicalAudience);
    }
     ...
     */
    @Override
    public void addMedicalAudience(MedicalAudience medicalAudience) {
        this.medicalAudience = add(this.medicalAudience, medicalAudience);
    }
    /**
     * Medical audience for page.
     *
     ...
     */
    @Override
    public void addMedicalAudience(MedicalAudienceType medicalAudience) {
        this.medicalAudience = add(this.medicalAudience, medicalAudience);
    }

    private List<Text> aspect;
     ...
     */
    @Override
    public List<Text> getAspectList() {
        return aspect;
    }
     ...
     */
    @Override
    public void addAspect(Text aspect) {
        this.aspect = add(this.aspect, aspect);
    }
