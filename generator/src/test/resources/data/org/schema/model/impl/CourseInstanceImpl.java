...
public class CourseInstanceImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CourseInstance {
     ...
     * A person assigned to instruct or provide instructional assistance for the [[CourseInstance]].
     *
     * @param fInstructor Person value to set.
     */
    @Override
    public void setInstructor(Person fInstructor) {
        this.fInstructor = fInstructor;
    }

    private Text fCourseWorkload;
     ...
     */
    @Override
    public Text getCourseWorkload() {
        return fCourseWorkload;
    }

    /**
     * The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
     *
     * @param fCourseWorkload Text value to set.
     * @see <a href="https://pending.schema.org">https://pending.schema.org</a>
     * @see <a href="https://github.com/schemaorg/schemaorg/issues/1909">https://github.com/schemaorg/schemaorg/issues/1909</a>
     */
    @Override
    public void setCourseWorkload(Text fCourseWorkload) {
        this.fCourseWorkload = fCourseWorkload;
    }
    /**
     * The amount of work expected of students taking the course, often provided as a figure per week or per month, and may be broken down by type. For example, "2 hours of lectures, 1 hour of lab work and 3 hours of independent study per week".
     *
     * @param fCourseWorkload java.lang.String value to set.
     * @see <a href="https://pending.schema.org">https://pending.schema.org</a>
     * @see <a href="https://github.com/schemaorg/schemaorg/issues/1909">https://github.com/schemaorg/schemaorg/issues/1909</a>
     */
    @Override
    public void setCourseWorkload(java.lang.String fCourseWorkload) {
        this.fCourseWorkload = Text.of(fCourseWorkload);
    }

    private Object fCourseMode;
     ...
     */
    @Override
    public <T> T getCourseMode() {
        return (T) fCourseMode;
    }

    /**
     * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
     *
     * @param fCourseMode URL value to set.
     */
    @Override
    public void setCourseMode(URL fCourseMode) {
        this.fCourseMode = fCourseMode;
    }
    /**
     * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
     *
     * @param fCourseMode java.net.URL value to set.
     */
    @Override
    public void setCourseMode(java.net.URL fCourseMode) {
        this.fCourseMode = URL.of(fCourseMode);
    }
    /**
     * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
     *
     * @param fCourseMode Text value to set.
     */
    @Override
    public void setCourseMode(Text fCourseMode) {
        this.fCourseMode = fCourseMode;
    }
    /**
     * The medium or means of delivery of the course instance or the mode of study, either as a text label (e.g. "online", "onsite" or "blended"; "synchronous" or "asynchronous"; "full-time" or "part-time") or as a URL reference to a term from a controlled vocabulary (e.g. https://ceds.ed.gov/element/001311#Asynchronous ).
     *
     * @param fCourseMode java.lang.String value to set.
     */
    @Override
    public void setCourseMode(java.lang.String fCourseMode) {
        this.fCourseMode = Text.of(fCourseMode);
    }
