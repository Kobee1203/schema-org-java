...
public class CourseInstanceImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CourseInstance {
     ...
     */
    @Override
    public void setCourseMode(Object fCourseMode) {
        if(!(fCourseMode instanceof URL) && !(fCourseMode instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'courseMode': " + fCourseMode);
        }
