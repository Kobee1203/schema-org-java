...
public class HowToDirectionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements HowToDirection {
    ...
    @JsonLdFieldTypes({ MediaObject.class, URL.class })
    private List<Object> afterMedia;
     ...
     */
    @Override
    public <T> List<T> getAfterMediaList() {
        return (List<T>) afterMedia;
    }
     ...
     */
    @Override
    public void addAfterMedia(MediaObject afterMedia) {
        this.afterMedia = add(this.afterMedia, afterMedia);
    }
    /**
     * A media object representing the circumstances after performing this direction.
     *
     ...
     */
    @Override
    public void addAfterMedia(URL afterMedia) {
        this.afterMedia = add(this.afterMedia, afterMedia);
    }

    @JsonLdFieldTypes({ MediaObject.class, URL.class })
    private List<Object> beforeMedia;
     ...
     */
    @Override
    public <T> List<T> getBeforeMediaList() {
        return (List<T>) beforeMedia;
    }
     ...
     */
    @Override
    public void addBeforeMedia(MediaObject beforeMedia) {
        this.beforeMedia = add(this.beforeMedia, beforeMedia);
    }
    /**
     * A media object representing the circumstances before performing this direction.
     *
     ...
     */
    @Override
    public void addBeforeMedia(URL beforeMedia) {
        this.beforeMedia = add(this.beforeMedia, beforeMedia);
    }
    ...
    @JsonLdFieldTypes({ MediaObject.class, URL.class })
    private List<Object> duringMedia;
     ...
     */
    @Override
    public <T> List<T> getDuringMediaList() {
        return (List<T>) duringMedia;
    }
     ...
     */
    @Override
    public void addDuringMedia(MediaObject duringMedia) {
        this.duringMedia = add(this.duringMedia, duringMedia);
    }
    /**
     * A media object representing the circumstances while performing this direction.
     *
     ...
     */
    @Override
    public void addDuringMedia(URL duringMedia) {
        this.duringMedia = add(this.duringMedia, duringMedia);
    }
