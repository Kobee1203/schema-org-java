...
import org.schema.model.HowToDirection;
...
public class HowToDirectionImpl implements HowToDirection {
     ...
     */
    @Override
    public <T> T getBeforeMedia() {
        return (T) fBeforeMedia;
    }
     ...
     */
    @Override
    public void setBeforeMedia(Object fBeforeMedia) {
        if(!(fBeforeMedia instanceof URL) && !(fBeforeMedia instanceof MediaObject)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'beforeMedia': " + fBeforeMedia);
        }
        this.fBeforeMedia = fBeforeMedia;
    }
     ...
     */
    @Override
    public <T> T getDuringMedia() {
        return (T) fDuringMedia;
    }
     ...
     */
    @Override
    public void setDuringMedia(Object fDuringMedia) {
        if(!(fDuringMedia instanceof URL) && !(fDuringMedia instanceof MediaObject)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'duringMedia': " + fDuringMedia);
        }
        this.fDuringMedia = fDuringMedia;
    }
     ...
     */
    @Override
    public <T> T getAfterMedia() {
        return (T) fAfterMedia;
    }
     ...
     */
    @Override
    public void setAfterMedia(Object fAfterMedia) {
        if(!(fAfterMedia instanceof URL) && !(fAfterMedia instanceof MediaObject)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'afterMedia': " + fAfterMedia);
        }
        this.fAfterMedia = fAfterMedia;
    }
