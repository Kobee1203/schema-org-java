...
import org.schema.model.ScreeningEvent;
...
public class ScreeningEventImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ScreeningEvent {
    ...
    private List<Movie> workPresented;
     ...
     */
    @Override
    public List<Movie> getWorkPresentedList() {
     ...
     */
    @Override
    public void addWorkPresented(Movie workPresented) {
        this.workPresented = add(this.workPresented, workPresented);
    }
