...
public class EmailMessageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements EmailMessage {
    ...
    @JsonLdFieldTypes({ Organization.class, ContactPoint.class, Person.class, Audience.class })
    ...
    @JsonLdFieldTypes({ Organization.class, ContactPoint.class, Person.class })
    ...
    @JsonLdFieldTypes({ Audience.class, Organization.class, Person.class })
    ...
    @JsonLdFieldTypes({ Person.class, Organization.class, ContactPoint.class, Audience.class })
