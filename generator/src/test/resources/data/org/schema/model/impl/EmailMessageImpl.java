...
public class EmailMessageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements EmailMessage {
    ...
    @JsonLdFieldTypes({ Person.class, ContactPoint.class, Organization.class })
    private List<Object> bccRecipient;
    ...
    public <T> T getBccRecipient() {
        return (T) getFirst(bccRecipient);
    }
    ...
    public void addBccRecipient(Person bccRecipient) {
        this.bccRecipient = add(this.bccRecipient, bccRecipient);
    }
    /**
     * A sub property of recipient. The recipient blind copied on a message.
     *
    ...
    private List<DateTime> dateReceived;
     ...
     */
    @Override
    public List<DateTime> getDateReceivedList() {
        return dateReceived;
    }
     ...
     */
    @Override
    public void addDateReceived(DateTime dateReceived) {
        this.dateReceived = add(this.dateReceived, dateReceived);
    }

    @JsonLdFieldTypes({ Person.class, Organization.class, ContactPoint.class })
    private List<Object> ccRecipient;
    ...
    public void addCcRecipient(Person ccRecipient) {
        this.ccRecipient = add(this.ccRecipient, ccRecipient);
    }
    /**
     * A sub property of recipient. The recipient copied on a message.
     *
    ...
    private List<CreativeWork> messageAttachment;
     ...
     */
    @Override
    public List<CreativeWork> getMessageAttachmentList() {
    ...
    public CreativeWork getMessageAttachment() {
        return getFirst(messageAttachment);
    }
     ...
     */
    @Override
    public void addMessageAttachment(CreativeWork messageAttachment) {
        this.messageAttachment = add(this.messageAttachment, messageAttachment);
    }

    @JsonLdFieldTypes({ ContactPoint.class, Person.class, Audience.class, Organization.class })
    private List<Object> toRecipient;
    ...
    public void addToRecipient(ContactPoint toRecipient) {
        this.toRecipient = add(this.toRecipient, toRecipient);
    }
    /**
     * A sub property of recipient. The recipient who was directly sent the message.
     *
    ...
    private List<DateTime> dateSent;
     ...
     */
    @Override
    public List<DateTime> getDateSentList() {
        return dateSent;
    }
     ...
     */
    @Override
    public void addDateSent(DateTime dateSent) {
        this.dateSent = add(this.dateSent, dateSent);
    }

    @JsonLdFieldTypes({ Date.class, DateTime.class })
    private List<Object> dateRead;
     ...
     */
    @Override
    public <T> List<T> getDateReadList() {
        return (List<T>) dateRead;
    }
     ...
     */
    @Override
    public void addDateRead(Date dateRead) {
        this.dateRead = add(this.dateRead, dateRead);
    }
    /**
     * The date/time at which the message has been read by the recipient if a single recipient exists.
     *
     ...
     */
    @Override
    public void addDateRead(DateTime dateRead) {
        this.dateRead = add(this.dateRead, dateRead);
    }

    @JsonLdFieldTypes({ Person.class, Audience.class, Organization.class })
    ...
    public void addSender(Person sender) {
        this.sender = add(this.sender, sender);
    }
    /**
     * A sub property of participant. The participant who is at the sending end of the action.
     *
