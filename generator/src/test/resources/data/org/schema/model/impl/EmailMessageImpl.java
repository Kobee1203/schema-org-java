...
public class EmailMessageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements EmailMessage {
    ...
    @JsonLdFieldTypes({ ContactPoint.class, Person.class, Organization.class, Audience.class })
    ...
    @JsonLdFieldTypes({ ContactPoint.class, Organization.class, Person.class })
    private List<Object> ccRecipient;

    /**
     * A sub property of recipient. The recipient copied on a message.
     *
     * @return {@link ContactPoint} or {@link Organization} or {@link Person}
     */
    @Override
    ...
    @JsonLdFieldTypes({ Organization.class, Audience.class, Person.class })
