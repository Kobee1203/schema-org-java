...
import org.schema.model.ClaimReview;
...
public class ClaimReviewImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ClaimReview {
    ...
    private List<Text> claimReviewed;
     ...
     */
    @Override
    public List<Text> getClaimReviewedList() {
     ...
     */
    @Override
    public Text getClaimReviewed() {
        return getFirst(claimReviewed);
    }
     ...
     */
    @Override
    public void addClaimReviewed(Text claimReviewed) {
        this.claimReviewed = add(this.claimReviewed, claimReviewed);
    }
