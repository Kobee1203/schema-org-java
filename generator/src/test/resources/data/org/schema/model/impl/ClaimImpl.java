...
public class ClaimImpl implements Claim {
    ...
    private CreativeWork fAppearance;
     ...
     */
    @Override
    public void setAppearance(CreativeWork fAppearance) {
        this.fAppearance = fAppearance;
    }
    ...
    private CreativeWork fFirstAppearance;
     ...
     */
    @Override
    public void setFirstAppearance(CreativeWork fFirstAppearance) {
        this.fFirstAppearance = fFirstAppearance;
    }
     ...
     */
    @Override
    public void setClaimInterpreter(Object fClaimInterpreter) {
        if(!(fClaimInterpreter instanceof Person) && !(fClaimInterpreter instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'claimInterpreter': " + fClaimInterpreter);
        }
        this.fClaimInterpreter = fClaimInterpreter;
    }
