...
public class ProductGroupImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ProductGroup {
     ...
     */
    @Override
    public void setVariesBy(Object fVariesBy) {
        if(!(fVariesBy instanceof Text) && !(fVariesBy instanceof DefinedTerm)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'variesBy': " + fVariesBy);
        }
