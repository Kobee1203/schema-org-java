...
public class ProductGroupImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ProductGroup {
     ...
     */
    @Override
    public void setHasVariant(Product fHasVariant) {
        this.fHasVariant = fHasVariant;
    }

    private Text fProductGroupID;
     ...
     */
    @Override
    public void setProductGroupID(Text fProductGroupID) {
     ...
     */
    @Override
    public void setProductGroupID(java.lang.String fProductGroupID) {
        this.fProductGroupID = Text.of(fProductGroupID);
    }

    private Object fVariesBy;
     ...
     */
    @Override
    public void setVariesBy(Text fVariesBy) {
        this.fVariesBy = fVariesBy;
    }
    /**
     * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. "color"; terms defined elsewhere can be referenced with their URIs.
     *
     ...
     */
    @Override
    public void setVariesBy(java.lang.String fVariesBy) {
        this.fVariesBy = Text.of(fVariesBy);
    }
    /**
     * Indicates the property or properties by which the variants in a [[ProductGroup]] vary, e.g. their size, color etc. Schema.org properties can be referenced by their short name e.g. "color"; terms defined elsewhere can be referenced with their URIs.
     *
     ...
     */
    @Override
    public void setVariesBy(DefinedTerm fVariesBy) {
        this.fVariesBy = fVariesBy;
    }
