...
public class MathSolverImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MathSolver {
    ...
    @JsonLdFieldTypes({ SolveMathAction.class, Text.class })
    private List<Object> mathExpression;
     ...
     */
    @Override
    public <T> List<T> getMathExpressionList() {
        return (List<T>) mathExpression;
    }
     ...
     */
    @Override
    public <T> T getMathExpression() {
        return (T) getFirst(mathExpression);
    }
     ...
     */
    @Override
    public void addMathExpression(SolveMathAction mathExpression) {
        this.mathExpression = add(this.mathExpression, mathExpression);
    }
    /**
     * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
     *
     ...
     */
    @Override
    public void addMathExpression(Text mathExpression) {
        this.mathExpression = add(this.mathExpression, mathExpression);
    }
