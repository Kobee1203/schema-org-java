...
public class MathSolverImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MathSolver {
     ...
     */
    @Override
    public void setMathExpression(Object fMathExpression) {
        if(!(fMathExpression instanceof SolveMathAction) && !(fMathExpression instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'mathExpression': " + fMathExpression);
        }
        this.fMathExpression = fMathExpression;
    }
