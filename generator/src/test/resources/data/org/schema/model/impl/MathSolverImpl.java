...
public class MathSolverImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MathSolver {
     ...
     */
    @Override
    public void setMathExpression(SolveMathAction fMathExpression) {
     ...
     */
    @Override
    public void setMathExpression(Text fMathExpression) {
        this.fMathExpression = fMathExpression;
    }
    /**
     * A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard.
     ...
     */
    @Override
    public void setMathExpression(java.lang.String fMathExpression) {
        this.fMathExpression = Text.of(fMathExpression);
    }
