...
public class EducationalOccupationalCredentialImpl implements EducationalOccupationalCredential {
     ...
     */
    @Override
    public void setCredentialCategory(Object fCredentialCategory) {
        if(!(fCredentialCategory instanceof URL) && !(fCredentialCategory instanceof DefinedTerm) && !(fCredentialCategory instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'credentialCategory': " + fCredentialCategory);
        }
     ...
     */
    @Override
    public void setCompetencyRequired(Object fCompetencyRequired) {
        if(!(fCompetencyRequired instanceof Text) && !(fCompetencyRequired instanceof DefinedTerm) && !(fCompetencyRequired instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'competencyRequired': " + fCompetencyRequired);
        }
