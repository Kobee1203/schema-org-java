...
import org.schema.model.MedicalRiskScore;
...
public class MedicalRiskScoreImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalRiskScore {
     ...
     */
    @Override
    public List<Text> getAlgorithmList() {
        return algorithm;
    }
     ...
     */
    @Override
    public Text getAlgorithm() {
        return getFirst(algorithm);
    }
     ...
     */
    @Override
    public void addAlgorithm(Text algorithm) {
        this.algorithm = add(this.algorithm, algorithm);
    }

    private List<MedicalEntity> estimatesRiskOf;
     ...
     */
    @Override
    public List<MedicalEntity> getEstimatesRiskOfList() {
    ...
    public MedicalEntity getEstimatesRiskOf() {
        return getFirst(estimatesRiskOf);
    }
     ...
     */
    @Override
    public void addEstimatesRiskOf(MedicalEntity estimatesRiskOf) {
        this.estimatesRiskOf = add(this.estimatesRiskOf, estimatesRiskOf);
    }

    private List<MedicalRiskFactor> includedRiskFactor;
     ...
     */
    @Override
    public List<MedicalRiskFactor> getIncludedRiskFactorList() {
    ...
    public MedicalRiskFactor getIncludedRiskFactor() {
        return getFirst(includedRiskFactor);
    }
     ...
     */
    @Override
    public void addIncludedRiskFactor(MedicalRiskFactor includedRiskFactor) {
        this.includedRiskFactor = add(this.includedRiskFactor, includedRiskFactor);
    }
