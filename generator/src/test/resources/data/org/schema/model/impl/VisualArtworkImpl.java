...
public class VisualArtworkImpl implements VisualArtwork {
     ...
     */
    @Override
    public void setArtform(Object fArtform) {
        if(!(fArtform instanceof Text) && !(fArtform instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'artform': " + fArtform);
        }
     ...
     */
    @Override
    public void setArtworkSurface(Object fArtworkSurface) {
        if(!(fArtworkSurface instanceof URL) && !(fArtworkSurface instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'artworkSurface': " + fArtworkSurface);
        }
     ...
     */
    @Override
    public void setSurface(Object fSurface) {
        if(!(fSurface instanceof URL) && !(fSurface instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'surface': " + fSurface);
        }
     ...
     */
    @Override
    public void setArtMedium(Object fArtMedium) {
        if(!(fArtMedium instanceof URL) && !(fArtMedium instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'artMedium': " + fArtMedium);
        }
     ...
     */
    @Override
    public void setArtEdition(Object fArtEdition) {
        if(!(fArtEdition instanceof Integer) && !(fArtEdition instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'artEdition': " + fArtEdition);
        }
