...
public class StatisticalPopulationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements StatisticalPopulation {
     ...
     */
    @Override
    public void setPopulationType(Class fPopulationType) {
        this.fPopulationType = fPopulationType;
    }

    private Integer fNumConstraints;
     ...
     */
    @Override
    public void setNumConstraints(Integer fNumConstraints) {
        this.fNumConstraints = fNumConstraints;
    }
    /**
     * Indicates the number of constraints (not counting [[populationType]]) defined for a particular [[StatisticalPopulation]]. This helps applications understand if they have access to a sufficiently complete description of a [[StatisticalPopulation]].
     *
     ...
     */
    @Override
    public void setNumConstraints(java.lang.Integer fNumConstraints) {
        this.fNumConstraints = Integer.of(fNumConstraints);
    }

    private Integer fConstrainingProperty;
     ...
     */
    @Override
    public void setConstrainingProperty(Integer fConstrainingProperty) {
        this.fConstrainingProperty = fConstrainingProperty;
    }
    /**
     * Indicates a property used as a constraint to define a [[StatisticalPopulation]] with respect to the set of entities
     *   corresponding to an indicated type (via [[populationType]]).
     ...
     */
    @Override
    public void setConstrainingProperty(java.lang.Integer fConstrainingProperty) {
        this.fConstrainingProperty = Integer.of(fConstrainingProperty);
    }
