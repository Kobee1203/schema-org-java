...
public class PublicationVolumeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements PublicationVolume {
    ...
    @JsonLdFieldTypes({ Text.class, Integer.class })
    private List<Object> volumeNumber;

    @Override
    public <T> List<T> getVolumeNumberList() {
        return (List<T>) volumeNumber;
    }

    @Override
    public <T> T getVolumeNumber() {
        return (T) getFirst(volumeNumber);
    }

    @Override
    public void addVolumeNumber(Text volumeNumber) {
        this.volumeNumber = add(this.volumeNumber, volumeNumber);
    }
    @Override
    public void addVolumeNumber(Integer volumeNumber) {
        this.volumeNumber = add(this.volumeNumber, volumeNumber);
    }
