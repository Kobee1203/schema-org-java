...
public class PublicationVolumeImpl implements PublicationVolume {
     ...
     */
    @Override
    public void setVolumeNumber(Object fVolumeNumber) {
        if(!(fVolumeNumber instanceof Integer) && !(fVolumeNumber instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'volumeNumber': " + fVolumeNumber);
        }
