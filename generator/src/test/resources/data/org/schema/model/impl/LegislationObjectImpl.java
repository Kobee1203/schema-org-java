...
public class LegislationObjectImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements LegislationObject {
    ...
    private List<LegalValueLevel> legislationLegalValue;
     ...
     */
    @Override
    public List<LegalValueLevel> getLegislationLegalValueList() {
    ...
    public LegalValueLevel getLegislationLegalValue() {
        return getFirst(legislationLegalValue);
    }
     ...
     */
    @Override
    public void addLegislationLegalValue(LegalValueLevel legislationLegalValue) {
        this.legislationLegalValue = add(this.legislationLegalValue, legislationLegalValue);
    }
    ...
    @JsonLdFieldTypes({ Organization.class, Person.class })
    private List<Object> legislationPassedBy;
    ...
    public <T> List<T> getLegislationPassedByList() {
        return (List<T>) legislationPassedBy;
    }
    ...
    public <T> T getLegislationPassedBy() {
        return (T) getFirst(legislationPassedBy);
    }
    ...
    public void addLegislationPassedBy(Organization legislationPassedBy) {
        this.legislationPassedBy = add(this.legislationPassedBy, legislationPassedBy);
    }
    /**
     * The person or organization that originally passed or made the law: typically parliament (for primary legislation) or government (for secondary legislation). This indicates the "legal author" of the law, as opposed to its physical author.
     *
    ...
    @JsonLdFieldTypes({ Text.class, URL.class })
    private List<Object> legislationIdentifier;
    ...
    public <T> List<T> getLegislationIdentifierList() {
        return (List<T>) legislationIdentifier;
    }
    ...
    public <T> T getLegislationIdentifier() {
        return (T) getFirst(legislationIdentifier);
    }
    ...
    public void addLegislationIdentifier(Text legislationIdentifier) {
        this.legislationIdentifier = add(this.legislationIdentifier, legislationIdentifier);
    }
    /**
     * An identifier for the legislation. This can be either a string-based identifier, like the CELEX at EU level or the NOR in France, or a web-based, URL/URI identifier, like an ELI (European Legislation Identifier) or an URN-Lex.
     *
    ...
    private List<Legislation> legislationCommences;
    ...
    public Legislation getLegislationCommences() {
        return getFirst(legislationCommences);
    }
    ...
    public void addLegislationCommences(Legislation legislationCommences) {
        this.legislationCommences = add(this.legislationCommences, legislationCommences);
    }

    private List<Legislation> legislationConsolidates;
    ...
    public Legislation getLegislationConsolidates() {
        return getFirst(legislationConsolidates);
    }
    ...
    public void addLegislationConsolidates(Legislation legislationConsolidates) {
        this.legislationConsolidates = add(this.legislationConsolidates, legislationConsolidates);
    }

    private List<Legislation> legislationTransposes;
    ...
    public Legislation getLegislationTransposes() {
        return getFirst(legislationTransposes);
    }
    ...
    public void addLegislationTransposes(Legislation legislationTransposes) {
        this.legislationTransposes = add(this.legislationTransposes, legislationTransposes);
    }

    @JsonLdFieldTypes({ Text.class, CategoryCode.class })
    private List<Object> legislationType;
    ...
    public <T> T getLegislationType() {
        return (T) getFirst(legislationType);
    }
    ...
    public void addLegislationType(Text legislationType) {
        this.legislationType = add(this.legislationType, legislationType);
    }
    /**
     * The type of the legislation. Examples of values are "law", "act", "directive", "decree", "regulation", "statutory instrument", "loi organique", "règlement grand-ducal", etc., depending on the country.
     *
    ...
    private List<Date> legislationDateOfApplicability;
    ...
    public Date getLegislationDateOfApplicability() {
        return getFirst(legislationDateOfApplicability);
    }
    ...
    public void addLegislationDateOfApplicability(Date legislationDateOfApplicability) {
        this.legislationDateOfApplicability = add(this.legislationDateOfApplicability, legislationDateOfApplicability);
    }

    @JsonLdFieldTypes({ Text.class, AdministrativeArea.class })
    private List<Object> legislationJurisdiction;
    ...
    public <T> List<T> getLegislationJurisdictionList() {
        return (List<T>) legislationJurisdiction;
    }
    ...
    public <T> T getLegislationJurisdiction() {
        return (T) getFirst(legislationJurisdiction);
    }
    ...
    public void addLegislationJurisdiction(Text legislationJurisdiction) {
        this.legislationJurisdiction = add(this.legislationJurisdiction, legislationJurisdiction);
    }
    /**
     * The jurisdiction from which the legislation originates.
     *
    ...
    private List<LegalForceStatus> legislationLegalForce;
    ...
    public LegalForceStatus getLegislationLegalForce() {
        return getFirst(legislationLegalForce);
    }
    ...
    public void addLegislationLegalForce(LegalForceStatus legislationLegalForce) {
        this.legislationLegalForce = add(this.legislationLegalForce, legislationLegalForce);
    }

    private List<Date> legislationDateVersion;
    ...
    public Date getLegislationDateVersion() {
        return getFirst(legislationDateVersion);
    }
    ...
    public void addLegislationDateVersion(Date legislationDateVersion) {
        this.legislationDateVersion = add(this.legislationDateVersion, legislationDateVersion);
    }

    private List<Legislation> legislationRepeals;
    ...
    public Legislation getLegislationRepeals() {
        return getFirst(legislationRepeals);
    }
    ...
    public void addLegislationRepeals(Legislation legislationRepeals) {
        this.legislationRepeals = add(this.legislationRepeals, legislationRepeals);
    }

    private List<Legislation> legislationEnsuresImplementationOf;
    ...
    public Legislation getLegislationEnsuresImplementationOf() {
        return getFirst(legislationEnsuresImplementationOf);
    }
    ...
    public void addLegislationEnsuresImplementationOf(Legislation legislationEnsuresImplementationOf) {
        this.legislationEnsuresImplementationOf = add(this.legislationEnsuresImplementationOf, legislationEnsuresImplementationOf);
    }

    @JsonLdFieldTypes({ AdministrativeArea.class, Text.class })
    private List<Object> jurisdiction;
     ...
     */
    @Override
    public <T> List<T> getJurisdictionList() {
        return (List<T>) jurisdiction;
    }
    ...
    public <T> T getJurisdiction() {
        return (T) getFirst(jurisdiction);
    }
     ...
     */
    @Override
    public void addJurisdiction(AdministrativeArea jurisdiction) {
        this.jurisdiction = add(this.jurisdiction, jurisdiction);
    }
    /**
     * Indicates a legal jurisdiction, e.g. of some legislation, or where some government service is based.
     *
     ...
     */
    @Override
    public void addJurisdiction(Text jurisdiction) {
        this.jurisdiction = add(this.jurisdiction, jurisdiction);
    }

    @JsonLdFieldTypes({ Person.class, Organization.class })
    private List<Object> legislationCountersignedBy;
    ...
    public <T> List<T> getLegislationCountersignedByList() {
        return (List<T>) legislationCountersignedBy;
    }
    ...
    public <T> T getLegislationCountersignedBy() {
        return (T) getFirst(legislationCountersignedBy);
    }
    ...
    public void addLegislationCountersignedBy(Person legislationCountersignedBy) {
        this.legislationCountersignedBy = add(this.legislationCountersignedBy, legislationCountersignedBy);
    }
    /**
     * The person or organization that countersigned the legislation. Depending on the legal context, a countersignature can indicate that the signed authority undertakes to assume responsibility for texts emanating from a person who is inviolable and irresponsible, (for example a King, Grand Duc or President), or that the authority is in charge of the implementation of the text.
     *
    ...
    private List<Legislation> legislationCorrects;
    ...
    public Legislation getLegislationCorrects() {
        return getFirst(legislationCorrects);
    }
    ...
    public void addLegislationCorrects(Legislation legislationCorrects) {
        this.legislationCorrects = add(this.legislationCorrects, legislationCorrects);
    }

    @JsonLdFieldTypes({ Person.class, Organization.class })
    private List<Object> legislationResponsible;
    ...
    public <T> List<T> getLegislationResponsibleList() {
        return (List<T>) legislationResponsible;
    }
    ...
    public <T> T getLegislationResponsible() {
        return (T) getFirst(legislationResponsible);
    }
    ...
    public void addLegislationResponsible(Person legislationResponsible) {
        this.legislationResponsible = add(this.legislationResponsible, legislationResponsible);
    }
    /**
     * An individual or organization that has some kind of responsibility for the legislation. Typically the ministry who is/was in charge of elaborating the legislation, or the adressee for potential questions about the legislation once it is published.
     *
    ...
    private List<Legislation> legislationAmends;
    ...
    public Legislation getLegislationAmends() {
        return getFirst(legislationAmends);
    }
    ...
    public void addLegislationAmends(Legislation legislationAmends) {
        this.legislationAmends = add(this.legislationAmends, legislationAmends);
    }

    private List<Date> legislationDate;
    ...
    public Date getLegislationDate() {
        return getFirst(legislationDate);
    }
    ...
    public void addLegislationDate(Date legislationDate) {
        this.legislationDate = add(this.legislationDate, legislationDate);
    }

    private List<Legislation> legislationApplies;
    ...
    public Legislation getLegislationApplies() {
        return getFirst(legislationApplies);
    }
    ...
    public void addLegislationApplies(Legislation legislationApplies) {
        this.legislationApplies = add(this.legislationApplies, legislationApplies);
    }

    private List<Legislation> legislationChanges;
    ...
    public Legislation getLegislationChanges() {
        return getFirst(legislationChanges);
    }
    ...
    public void addLegislationChanges(Legislation legislationChanges) {
        this.legislationChanges = add(this.legislationChanges, legislationChanges);
    }
}
