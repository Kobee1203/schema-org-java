...
public class TVEpisodeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements TVEpisode {
     ...
     */
    @Override
    public void setTitleEIDR(URL fTitleEIDR) {
        this.fTitleEIDR = fTitleEIDR;
    }
    /**
     * An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]] representing at the most general/abstract level, a work of film or television.
     * 
     ...
     */
    @Override
    public void setTitleEIDR(java.net.URL fTitleEIDR) {
        this.fTitleEIDR = URL.of(fTitleEIDR);
    }
    /**
     * An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]] representing at the most general/abstract level, a work of film or television.
     * 
     ...
     */
    @Override
    public void setTitleEIDR(Text fTitleEIDR) {
        this.fTitleEIDR = fTitleEIDR;
    }
    /**
     * An [EIDR](https://eidr.org/) (Entertainment Identifier Registry) [[identifier]] representing at the most general/abstract level, a work of film or television.
     ...
     */
    @Override
    public void setTitleEIDR(java.lang.String fTitleEIDR) {
        this.fTitleEIDR = Text.of(fTitleEIDR);
    }
     ...
     */
    @Override
    public void setSubtitleLanguage(Language fSubtitleLanguage) {
        this.fSubtitleLanguage = fSubtitleLanguage;
    }
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
     *
     ...
     */
    @Override
    public void setSubtitleLanguage(Text fSubtitleLanguage) {
        this.fSubtitleLanguage = fSubtitleLanguage;
    }
    /**
     * Languages in which subtitles/captions are available, in [IETF BCP 47 standard format](http://tools.ietf.org/html/bcp47).
     ...
     */
    @Override
    public void setSubtitleLanguage(java.lang.String fSubtitleLanguage) {
        this.fSubtitleLanguage = Text.of(fSubtitleLanguage);
    }
    ...
    public TVSeries getPartOfTVSeries() {
        return fPartOfTVSeries;
    }

    /**
     * The TV series to which this episode or season belongs.
     *
     * @param fPartOfTVSeries TVSeries value to set.
     */
    @Override
    public void setPartOfTVSeries(TVSeries fPartOfTVSeries) {
        this.fPartOfTVSeries = fPartOfTVSeries;
    }
    ...
    public <T> T getEpisodeNumber() {
        return (T) fEpisodeNumber;
    }

    /**
     * Position of the episode within an ordered group of episodes.
     *
     * @param fEpisodeNumber Integer value to set.
     */
    @Override
    public void setEpisodeNumber(Integer fEpisodeNumber) {
        this.fEpisodeNumber = fEpisodeNumber;
    }
    /**
     * Position of the episode within an ordered group of episodes.
     *
     * @param fEpisodeNumber java.lang.Integer value to set.
     */
    @Override
    public void setEpisodeNumber(java.lang.Integer fEpisodeNumber) {
        this.fEpisodeNumber = Integer.of(fEpisodeNumber);
    }
    /**
     * Position of the episode within an ordered group of episodes.
     *
     * @param fEpisodeNumber Text value to set.
     */
    @Override
    public void setEpisodeNumber(Text fEpisodeNumber) {
        this.fEpisodeNumber = fEpisodeNumber;
    }
    /**
     * Position of the episode within an ordered group of episodes.
     *
     * @param fEpisodeNumber java.lang.String value to set.
     */
    @Override
    public void setEpisodeNumber(java.lang.String fEpisodeNumber) {
        this.fEpisodeNumber = Text.of(fEpisodeNumber);
    }
    ...
    private CreativeWorkSeries fPartOfSeries;
     ...
     */
    @Override
    public void setPartOfSeries(CreativeWorkSeries fPartOfSeries) {
        this.fPartOfSeries = fPartOfSeries;
    }
    ...
    private CreativeWorkSeason fPartOfSeason;
     ...
     */
    @Override
    public void setPartOfSeason(CreativeWorkSeason fPartOfSeason) {
        this.fPartOfSeason = fPartOfSeason;
    }
