...
public class TVEpisodeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements TVEpisode {
     ...
     */
    @Override
    public void setTitleEIDR(Object fTitleEIDR) {
        if(!(fTitleEIDR instanceof URL) && !(fTitleEIDR instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'titleEIDR': " + fTitleEIDR);
        }
     ...
     */
    @Override
    public void setSubtitleLanguage(Object fSubtitleLanguage) {
        if(!(fSubtitleLanguage instanceof Language) && !(fSubtitleLanguage instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'subtitleLanguage': " + fSubtitleLanguage);
        }
     ...
     */
    @Override
    public void setEpisodeNumber(Object fEpisodeNumber) {
        if(!(fEpisodeNumber instanceof Integer) && !(fEpisodeNumber instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'episodeNumber': " + fEpisodeNumber);
        }
