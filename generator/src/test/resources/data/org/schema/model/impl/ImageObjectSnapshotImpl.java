...
public class ImageObjectSnapshotImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ImageObjectSnapshot {
     ...
     */
    @Override
    public void setExifData(Object fExifData) {
        if(!(fExifData instanceof PropertyValue) && !(fExifData instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'exifData': " + fExifData);
        }
