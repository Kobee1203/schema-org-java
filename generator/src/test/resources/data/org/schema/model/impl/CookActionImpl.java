...
public class CookActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CookAction {
    ...
    @JsonLdFieldTypes({ Place.class, FoodEstablishment.class })
    private List<Object> foodEstablishment;
    ...
    public <T> List<T> getFoodEstablishmentList() {
        return (List<T>) foodEstablishment;
    }
    ...
    public <T> T getFoodEstablishment() {
        return (T) getFirst(foodEstablishment);
    }
    ...
    public void addFoodEstablishment(Place foodEstablishment) {
        this.foodEstablishment = add(this.foodEstablishment, foodEstablishment);
    }
    /**
     * A sub property of location. The specific food establishment where the action occurred.
     *
    ...
    private List<FoodEvent> foodEvent;
    ...
    public void addFoodEvent(FoodEvent foodEvent) {
        this.foodEvent = add(this.foodEvent, foodEvent);
    }
    ...
    public void addRecipe(Recipe recipe) {
        this.recipe = add(this.recipe, recipe);
    }
