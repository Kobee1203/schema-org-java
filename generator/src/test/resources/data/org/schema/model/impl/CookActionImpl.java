...
public class CookActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements CookAction {
     ...
     */
    @Override
    public void setRecipe(Recipe fRecipe) {
        this.fRecipe = fRecipe;
    }

    private Object fFoodEstablishment;
     ...
     */
    @Override
    public void setFoodEstablishment(Object fFoodEstablishment) {
        if(!(fFoodEstablishment instanceof Place) && !(fFoodEstablishment instanceof FoodEstablishment)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'foodEstablishment': " + fFoodEstablishment);
        }
        this.fFoodEstablishment = fFoodEstablishment;
    }

    private FoodEvent fFoodEvent;
     ...
     */
    @Override
    public void setFoodEvent(FoodEvent fFoodEvent) {
        this.fFoodEvent = fFoodEvent;
    }
