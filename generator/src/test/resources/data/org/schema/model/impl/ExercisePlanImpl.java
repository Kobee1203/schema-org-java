...
public class ExercisePlanImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ExercisePlan {
    ...
    private List<Object> repetitions;
     ...
     */
    @Override
    public <T> List<T> getRepetitionsList() {
        return (List<T>) repetitions;
    }
     ...
     */
    @Override
    public void addRepetitions(Number repetitions) {
        this.repetitions = add(this.repetitions, repetitions);
    }
    /**
     * Number of times one should repeat the activity.
     *
     ...
     */
    @Override
    public void addRepetitions(QuantitativeValue repetitions) {
        this.repetitions = add(this.repetitions, repetitions);
    }

    @JsonLdFieldTypes({ QuantitativeValue.class, Text.class })
    private List<Object> intensity;
     ...
     */
    @Override
    public <T> List<T> getIntensityList() {
        return (List<T>) intensity;
    }
     ...
     */
    @Override
    public void addIntensity(QuantitativeValue intensity) {
        this.intensity = add(this.intensity, intensity);
    }
    /**
     * Quantitative measure gauging the degree of force involved in the exercise, for example, heartbeats per minute. May include the velocity of the movement.
     *
     ...
     */
    @Override
    public void addIntensity(Text intensity) {
        this.intensity = add(this.intensity, intensity);
    }

    @JsonLdFieldTypes({ QuantitativeValue.class, Energy.class })
    private List<Object> workload;
     ...
     */
    @Override
    public <T> List<T> getWorkloadList() {
        return (List<T>) workload;
    }
     ...
     */
    @Override
    public void addWorkload(QuantitativeValue workload) {
        this.workload = add(this.workload, workload);
    }
    /**
     * Quantitative measure of the physiologic output of the exercise; also referred to as energy expenditure.
     *
     ...
     */
    @Override
    public void addWorkload(Energy workload) {
        this.workload = add(this.workload, workload);
    }

    @JsonLdFieldTypes({ Duration.class, QuantitativeValue.class })
    private List<Object> activityDuration;
     ...
     */
    @Override
    public <T> List<T> getActivityDurationList() {
        return (List<T>) activityDuration;
    }
    ...
    public <T> T getActivityDuration() {
        return (T) getFirst(activityDuration);
    }
     ...
     */
    @Override
    public void addActivityDuration(Duration activityDuration) {
        this.activityDuration = add(this.activityDuration, activityDuration);
    }
    /**
     * Length of time to engage in the activity.
     *
     ...
     */
    @Override
    public void addActivityDuration(QuantitativeValue activityDuration) {
        this.activityDuration = add(this.activityDuration, activityDuration);
    }

    @JsonLdFieldTypes({ Text.class, QuantitativeValue.class })
    private List<Object> restPeriods;
     ...
     */
    @Override
    public <T> List<T> getRestPeriodsList() {
        return (List<T>) restPeriods;
    }
     ...
     */
    @Override
    public void addRestPeriods(Text restPeriods) {
        this.restPeriods = add(this.restPeriods, restPeriods);
    }
    /**
     * How often one should break from the activity.
     *
     ...
     */
    @Override
    public void addRestPeriods(QuantitativeValue restPeriods) {
        this.restPeriods = add(this.restPeriods, restPeriods);
    }

    @JsonLdFieldTypes({ Text.class, QuantitativeValue.class })
    private List<Object> activityFrequency;
     ...
     */
    @Override
    public <T> List<T> getActivityFrequencyList() {
        return (List<T>) activityFrequency;
    }
    ...
    public <T> T getActivityFrequency() {
        return (T) getFirst(activityFrequency);
    }
     ...
     */
    @Override
    public void addActivityFrequency(Text activityFrequency) {
        this.activityFrequency = add(this.activityFrequency, activityFrequency);
    }
    /**
     * How often one should engage in the activity.
     *
     ...
     */
    @Override
    public void addActivityFrequency(QuantitativeValue activityFrequency) {
        this.activityFrequency = add(this.activityFrequency, activityFrequency);
    }

    private List<Text> additionalVariable;
     ...
     */
    @Override
    public List<Text> getAdditionalVariableList() {
    ...
    public Text getAdditionalVariable() {
        return getFirst(additionalVariable);
    }
     ...
     */
    @Override
    public void addAdditionalVariable(Text additionalVariable) {
        this.additionalVariable = add(this.additionalVariable, additionalVariable);
    }
