...
public class ExercisePlanImpl implements ExercisePlan {
     ...
     */
    @Override
    public void setWorkload(Object fWorkload) {
        if(!(fWorkload instanceof QuantitativeValue) && !(fWorkload instanceof Energy)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'workload': " + fWorkload);
        }
     ...
     */
    @Override
    public void setIntensity(Object fIntensity) {
        if(!(fIntensity instanceof QuantitativeValue) && !(fIntensity instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'intensity': " + fIntensity);
        }
     ...
     */
    @Override
    public void setActivityDuration(Object fActivityDuration) {
        if(!(fActivityDuration instanceof Duration) && !(fActivityDuration instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'activityDuration': " + fActivityDuration);
        }
     ...
     */
    @Override
    public void setActivityFrequency(Object fActivityFrequency) {
        if(!(fActivityFrequency instanceof Text) && !(fActivityFrequency instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'activityFrequency': " + fActivityFrequency);
        }
     ...
     */
    @Override
    public void setRestPeriods(Object fRestPeriods) {
        if(!(fRestPeriods instanceof Text) && !(fRestPeriods instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'restPeriods': " + fRestPeriods);
        }
     ...
     */
    @Override
    public void setRepetitions(Object fRepetitions) {
        if(!(fRepetitions instanceof Number) && !(fRepetitions instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'repetitions': " + fRepetitions);
        }
