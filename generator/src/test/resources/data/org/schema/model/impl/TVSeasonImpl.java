...
public class TVSeasonImpl implements TVSeason {
     ...
     */
    @Override
    public void setSeasonNumber(Object fSeasonNumber) {
        if(!(fSeasonNumber instanceof Text) && !(fSeasonNumber instanceof Integer)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'seasonNumber': " + fSeasonNumber);
        }
