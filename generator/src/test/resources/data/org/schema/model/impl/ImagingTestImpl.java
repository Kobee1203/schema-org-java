...
public class ImagingTestImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ImagingTest {
    ...
    private List<MedicalImagingTechnique> imagingTechnique;

    @Override
    public List<MedicalImagingTechnique> getImagingTechniqueList() {
        return imagingTechnique;
    }

    @Override
    public MedicalImagingTechnique getImagingTechnique() {
        return getFirst(imagingTechnique);
    }

    @Override
    public void addImagingTechnique(MedicalImagingTechnique imagingTechnique) {
        this.imagingTechnique = add(this.imagingTechnique, imagingTechnique);
    }
