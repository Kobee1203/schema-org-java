...
public class MedicalTestPanelImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalTestPanel {
    ...
    private List<MedicalTest> subTest;

    @Override
    public List<MedicalTest> getSubTestList() {
        return subTest;
    }

    @Override
    public MedicalTest getSubTest() {
        return getFirst(subTest);
    }

    @Override
    public void addSubTest(MedicalTest subTest) {
        this.subTest = add(this.subTest, subTest);
    }
