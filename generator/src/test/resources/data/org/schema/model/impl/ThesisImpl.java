...
import org.schema.model.Thesis;
...
public class ThesisImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Thesis {
     ...
     */
    @Override
    public List<Text> getInSupportOfList() {
        return inSupportOf;
    }
     ...
     */
    @Override
    public Text getInSupportOf() {
        return getFirst(inSupportOf);
    }
     ...
     */
    @Override
    public void addInSupportOf(Text inSupportOf) {
        this.inSupportOf = add(this.inSupportOf, inSupportOf);
    }
