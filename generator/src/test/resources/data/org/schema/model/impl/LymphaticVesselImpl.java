...
public class LymphaticVesselImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements LymphaticVessel {
     ...
     * The vasculature the lymphatic structure runs, or efferents, to.
     *
     * @param fRunsTo Vessel value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
     ...
     */
    @Override
    public void setRegionDrained(AnatomicalSystem fRegionDrained) {
     ...
     */
    @Override
    public void setRegionDrained(AnatomicalStructure fRegionDrained) {
        this.fRegionDrained = fRegionDrained;
    }
     ...
     * The vasculature the lymphatic structure originates, or afferents, from.
     *
     * @param fOriginatesFrom Vessel value to set.
     * @see <a href="https://health-lifesci.schema.org">https://health-lifesci.schema.org</a>
     */
    @Override
