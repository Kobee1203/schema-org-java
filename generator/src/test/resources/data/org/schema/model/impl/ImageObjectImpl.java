...
public class ImageObjectImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ImageObject {
    ...
    private List<Boolean> representativeOfPage;
     ...
     */
    @Override
    public List<Boolean> getRepresentativeOfPageList() {
    ...
    public Boolean getRepresentativeOfPage() {
        return getFirst(representativeOfPage);
    }
     ...
     */
    @Override
    public void addRepresentativeOfPage(Boolean representativeOfPage) {
        this.representativeOfPage = add(this.representativeOfPage, representativeOfPage);
    }
     ...
     */
    @Override
    public <T> List<T> getExifDataList() {
        return (List<T>) exifData;
    }
     ...
     */
    @Override
    public <T> T getExifData() {
        return (T) getFirst(exifData);
    }
     ...
     */
    @Override
    public void addExifData(PropertyValue exifData) {
        this.exifData = add(this.exifData, exifData);
    }
    /**
     * exif data for this object.
     *
     ...
     */
    @Override
    public void addExifData(Text exifData) {
        this.exifData = add(this.exifData, exifData);
    }
