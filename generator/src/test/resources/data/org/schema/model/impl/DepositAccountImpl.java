...
public class DepositAccountImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements DepositAccount {
     ...
     */
    @Override
    public void setBankAccountType(Text fBankAccountType) {
        this.fBankAccountType = fBankAccountType;
    }
    /**
     * The type of a bank account.
     *
     ...
     */
    @Override
    public void setBankAccountType(java.lang.String fBankAccountType) {
        this.fBankAccountType = Text.of(fBankAccountType);
    }
    /**
     * The type of a bank account.
     *
     ...
     */
    @Override
    public void setBankAccountType(URL fBankAccountType) {
        this.fBankAccountType = fBankAccountType;
    }
    /**
     * The type of a bank account.
     ...
     */
    @Override
    public void setBankAccountType(java.net.URL fBankAccountType) {
        this.fBankAccountType = URL.of(fBankAccountType);
    }

    private MonetaryAmount fAccountMinimumInflow;
     ...
     */
    @Override
    public void setAccountMinimumInflow(MonetaryAmount fAccountMinimumInflow) {
        this.fAccountMinimumInflow = fAccountMinimumInflow;
    }

    private MonetaryAmount fAccountOverdraftLimit;
     ...
     */
    @Override
    public void setAccountOverdraftLimit(MonetaryAmount fAccountOverdraftLimit) {
        this.fAccountOverdraftLimit = fAccountOverdraftLimit;
    }
}
