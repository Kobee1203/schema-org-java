...
public class DepositAccountImpl implements DepositAccount {
     ...
     */
    @Override
    public void setBankAccountType(Object fBankAccountType) {
        if(!(fBankAccountType instanceof Text) && !(fBankAccountType instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'bankAccountType': " + fBankAccountType);
        }
