...
public class GovernmentServiceImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements GovernmentService {
    ...
    private List<Organization> serviceOperator;
     ...
     */
    @Override
    public List<Organization> getServiceOperatorList() {
    ...
    public Organization getServiceOperator() {
        return getFirst(serviceOperator);
    }
     ...
     */
    @Override
    public void addServiceOperator(Organization serviceOperator) {
        this.serviceOperator = add(this.serviceOperator, serviceOperator);
    }
