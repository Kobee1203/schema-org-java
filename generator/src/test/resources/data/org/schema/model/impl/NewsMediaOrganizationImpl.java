...
public class NewsMediaOrganizationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements NewsMediaOrganization {
     ...
     */
    @Override
    public void setMissionCoveragePrioritiesPolicy(Object fMissionCoveragePrioritiesPolicy) {
        if(!(fMissionCoveragePrioritiesPolicy instanceof CreativeWork) && !(fMissionCoveragePrioritiesPolicy instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'missionCoveragePrioritiesPolicy': " + fMissionCoveragePrioritiesPolicy);
        }
     ...
     */
    @Override
    public void setMasthead(Object fMasthead) {
        if(!(fMasthead instanceof URL) && !(fMasthead instanceof CreativeWork)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'masthead': " + fMasthead);
        }
     ...
     */
    @Override
    public void setVerificationFactCheckingPolicy(Object fVerificationFactCheckingPolicy) {
        if(!(fVerificationFactCheckingPolicy instanceof URL) && !(fVerificationFactCheckingPolicy instanceof CreativeWork)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'verificationFactCheckingPolicy': " + fVerificationFactCheckingPolicy);
        }
     ...
     */
    @Override
    public void setNoBylinesPolicy(Object fNoBylinesPolicy) {
        if(!(fNoBylinesPolicy instanceof CreativeWork) && !(fNoBylinesPolicy instanceof URL)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'noBylinesPolicy': " + fNoBylinesPolicy);
        }
