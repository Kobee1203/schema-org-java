...
public class NewsMediaOrganizationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements NewsMediaOrganization {
    ...
    private Object fMissionCoveragePrioritiesPolicy;
    ...
    public <T> T getMissionCoveragePrioritiesPolicy() {
        return (T) fMissionCoveragePrioritiesPolicy;
    }
     ...
     */
    @Override
    public void setMissionCoveragePrioritiesPolicy(CreativeWork fMissionCoveragePrioritiesPolicy) {
        this.fMissionCoveragePrioritiesPolicy = fMissionCoveragePrioritiesPolicy;
    }
    /**
     * For a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues.
     *
     ...
     */
    @Override
    public void setMissionCoveragePrioritiesPolicy(URL fMissionCoveragePrioritiesPolicy) {
        this.fMissionCoveragePrioritiesPolicy = fMissionCoveragePrioritiesPolicy;
    }
    /**
     * For a [[NewsMediaOrganization]], a statement on coverage priorities, including any public agenda or stance on issues.
     ...
     */
    @Override
    public void setMissionCoveragePrioritiesPolicy(java.net.URL fMissionCoveragePrioritiesPolicy) {
        this.fMissionCoveragePrioritiesPolicy = URL.of(fMissionCoveragePrioritiesPolicy);
    }
     ...
     */
    @Override
    public void setMasthead(URL fMasthead) {
        this.fMasthead = fMasthead;
    }
    /**
     * For a [[NewsMediaOrganization]], a link to the masthead page or a page listing top editorial management.
     *
     ...
     */
    @Override
    public void setMasthead(java.net.URL fMasthead) {
        this.fMasthead = URL.of(fMasthead);
    }
    /**
     * For a [[NewsMediaOrganization]], a link to the masthead page or a page listing top editorial management.
     *
     ...
     */
    @Override
    public void setMasthead(CreativeWork fMasthead) {
        this.fMasthead = fMasthead;
    }
    ...
    private Object fVerificationFactCheckingPolicy;
    ...
    public <T> T getVerificationFactCheckingPolicy() {
        return (T) fVerificationFactCheckingPolicy;
    }
     ...
     */
    @Override
    public void setVerificationFactCheckingPolicy(URL fVerificationFactCheckingPolicy) {
        this.fVerificationFactCheckingPolicy = fVerificationFactCheckingPolicy;
    }
    /**
     * Disclosure about verification and fact-checking processes for a [[NewsMediaOrganization]] or other fact-checking [[Organization]].
     *
     ...
     */
    @Override
    public void setVerificationFactCheckingPolicy(java.net.URL fVerificationFactCheckingPolicy) {
        this.fVerificationFactCheckingPolicy = URL.of(fVerificationFactCheckingPolicy);
    }
    /**
     * Disclosure about verification and fact-checking processes for a [[NewsMediaOrganization]] or other fact-checking [[Organization]].
     *
     ...
     */
    @Override
    public void setVerificationFactCheckingPolicy(CreativeWork fVerificationFactCheckingPolicy) {
        this.fVerificationFactCheckingPolicy = fVerificationFactCheckingPolicy;
    }

    private Object fNoBylinesPolicy;
     ...
     */
    @Override
    public void setNoBylinesPolicy(CreativeWork fNoBylinesPolicy) {
        this.fNoBylinesPolicy = fNoBylinesPolicy;
    }
    /**
     * For a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement explaining when authors of articles are not named in bylines.
     *
     ...
     */
    @Override
    public void setNoBylinesPolicy(URL fNoBylinesPolicy) {
        this.fNoBylinesPolicy = fNoBylinesPolicy;
    }
    /**
     * For a [[NewsMediaOrganization]] or other news-related [[Organization]], a statement explaining when authors of articles are not named in bylines.
     ...
     */
    @Override
    public void setNoBylinesPolicy(java.net.URL fNoBylinesPolicy) {
        this.fNoBylinesPolicy = URL.of(fNoBylinesPolicy);
    }
