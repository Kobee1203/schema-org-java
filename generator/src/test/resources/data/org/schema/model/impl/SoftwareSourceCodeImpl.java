...
public class SoftwareSourceCodeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SoftwareSourceCode {
    ...
    private List<Text> runtimePlatform;
     ...
     */
    @Override
    public List<Text> getRuntimePlatformList() {
     ...
     */
    @Override
    public Text getRuntimePlatform() {
        return getFirst(runtimePlatform);
    }
    ...
    @JsonLdFieldTypes({ Text.class, ComputerLanguage.class })
