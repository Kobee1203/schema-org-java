...
import org.schema.model.SoftwareSourceCode;
...
public class SoftwareSourceCodeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SoftwareSourceCode {
    ...
    private List<URL> codeRepository;

    @Override
    public List<URL> getCodeRepositoryList() {
        return codeRepository;
    }

    @Override
    public URL getCodeRepository() {
        return getFirst(codeRepository);
    }

    @Override
    public void addCodeRepository(URL codeRepository) {
        this.codeRepository = add(this.codeRepository, codeRepository);
    }

    private List<Text> codeSampleType;

    @Override
    public List<Text> getCodeSampleTypeList() {
        return codeSampleType;
    }

    @Override
    public Text getCodeSampleType() {
        return getFirst(codeSampleType);
    }

    @Override
    public void addCodeSampleType(Text codeSampleType) {
        this.codeSampleType = add(this.codeSampleType, codeSampleType);
    }
    ...
    @JsonLdFieldTypes({ ComputerLanguage.class, Text.class })
    private List<Object> programmingLanguage;

    @Override
    public <T> List<T> getProgrammingLanguageList() {
        return (List<T>) programmingLanguage;
    }

    @Override
    public <T> T getProgrammingLanguage() {
        return (T) getFirst(programmingLanguage);
    }

    @Override
    public void addProgrammingLanguage(ComputerLanguage programmingLanguage) {
        this.programmingLanguage = add(this.programmingLanguage, programmingLanguage);
    }
    @Override
    public void addProgrammingLanguage(Text programmingLanguage) {
        this.programmingLanguage = add(this.programmingLanguage, programmingLanguage);
    }
    ...
    private List<Text> runtime;

    @Override
    public List<Text> getRuntimeList() {
        return runtime;
    }

    @Override
    public Text getRuntime() {
        return getFirst(runtime);
    }

    @Override
    public void addRuntime(Text runtime) {
        this.runtime = add(this.runtime, runtime);
    }
    ...
    private List<Text> sampleType;

    @Override
    public List<Text> getSampleTypeList() {
        return sampleType;
    }

    @Override
    public Text getSampleType() {
        return getFirst(sampleType);
    }

    @Override
    public void addSampleType(Text sampleType) {
        this.sampleType = add(this.sampleType, sampleType);
    }
    ...
    private List<SoftwareApplication> targetProduct;

    @Override
    public List<SoftwareApplication> getTargetProductList() {
        return targetProduct;
    }

    @Override
    public SoftwareApplication getTargetProduct() {
        return getFirst(targetProduct);
    }

    @Override
    public void addTargetProduct(SoftwareApplication targetProduct) {
        this.targetProduct = add(this.targetProduct, targetProduct);
    }
