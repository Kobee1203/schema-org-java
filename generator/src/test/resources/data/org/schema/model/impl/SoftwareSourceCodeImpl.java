...
public class SoftwareSourceCodeImpl implements SoftwareSourceCode {
     ...
     */
    @Override
    public void setProgrammingLanguage(Object fProgrammingLanguage) {
        if(!(fProgrammingLanguage instanceof Text) && !(fProgrammingLanguage instanceof ComputerLanguage)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'programmingLanguage': " + fProgrammingLanguage);
        }
