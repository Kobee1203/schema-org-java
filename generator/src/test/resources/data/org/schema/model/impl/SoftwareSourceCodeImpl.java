...
public class SoftwareSourceCodeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements SoftwareSourceCode {
     ...
     */
    @Override
    public void setProgrammingLanguage(Text fProgrammingLanguage) {
        this.fProgrammingLanguage = fProgrammingLanguage;
    }
    /**
     * The computer programming language.
     *
     ...
     */
    @Override
    public void setProgrammingLanguage(java.lang.String fProgrammingLanguage) {
        this.fProgrammingLanguage = Text.of(fProgrammingLanguage);
    }
    /**
     * The computer programming language.
     *
     ...
     */
    @Override
    public void setProgrammingLanguage(ComputerLanguage fProgrammingLanguage) {
        this.fProgrammingLanguage = fProgrammingLanguage;
    }

    private Text fSampleType;
     ...
     */
    @Override
    public void setSampleType(Text fSampleType) {
     ...
     */
    @Override
    public void setSampleType(java.lang.String fSampleType) {
        this.fSampleType = Text.of(fSampleType);
    }

    private Text fRuntimePlatform;
     ...
     */
    @Override
    public void setRuntimePlatform(Text fRuntimePlatform) {
        this.fRuntimePlatform = fRuntimePlatform;
    }
    /**
     * Runtime platform or script interpreter dependencies (Example - Java v1, Python2.3, .Net Framework 3.0).
     *
     ...
     */
    @Override
    public void setRuntimePlatform(java.lang.String fRuntimePlatform) {
        this.fRuntimePlatform = Text.of(fRuntimePlatform);
    }

    private Text fRuntime;
     ...
     */
    @Override
    public void setRuntime(Text fRuntime) {
     ...
     */
    @Override
    public void setRuntime(java.lang.String fRuntime) {
        this.fRuntime = Text.of(fRuntime);
    }

    private SoftwareApplication fTargetProduct;
     ...
     */
    @Override
    public void setTargetProduct(SoftwareApplication fTargetProduct) {
        this.fTargetProduct = fTargetProduct;
    }

    private URL fCodeRepository;
     ...
     */
    @Override
    public void setCodeRepository(URL fCodeRepository) {
        this.fCodeRepository = fCodeRepository;
    }
    /**
     * Link to the repository where the un-compiled, human readable code and related code is located (SVN, github, CodePlex).
     *
     ...
     */
    @Override
    public void setCodeRepository(java.net.URL fCodeRepository) {
        this.fCodeRepository = URL.of(fCodeRepository);
    }

    private Text fCodeSampleType;
     ...
     */
    @Override
    public void setCodeSampleType(Text fCodeSampleType) {
        this.fCodeSampleType = fCodeSampleType;
    }
    /**
     * What type of code sample: full (compile ready) solution, code snippet, inline code, scripts, template.
     *
     ...
     */
    @Override
    public void setCodeSampleType(java.lang.String fCodeSampleType) {
        this.fCodeSampleType = Text.of(fCodeSampleType);
    }
