...
public class CommentImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Comment {
    ...
    private List<Integer> upvoteCount;
     ...
     */
    @Override
    public List<Integer> getUpvoteCountList() {
        return upvoteCount;
    }
     ...
     */
    @Override
    public void addUpvoteCount(Integer upvoteCount) {
        this.upvoteCount = add(this.upvoteCount, upvoteCount);
    }

    private List<Integer> downvoteCount;
     ...
     */
    @Override
    public List<Integer> getDownvoteCountList() {
     ...
     */
    @Override
    public void addDownvoteCount(Integer downvoteCount) {
        this.downvoteCount = add(this.downvoteCount, downvoteCount);
    }
    ...
    @JsonLdFieldTypes({ CreativeWork.class, Comment.class })
    private List<Object> parentItem;
     ...
     */
    @Override
    public <T> List<T> getParentItemList() {
        return (List<T>) parentItem;
    }
     ...
     */
    @Override
    public <T> T getParentItem() {
        return (T) getFirst(parentItem);
    }
     ...
     */
    @Override
    public void addParentItem(CreativeWork parentItem) {
        this.parentItem = add(this.parentItem, parentItem);
    }
    /**
     * The parent of a question, answer or item in general. Typically used for Q/A discussion threads e.g. a chain of comments with the first comment being an [[Article]] or other [[CreativeWork]]. See also [[comment]] which points from something to a comment about it.
     *
     ...
     */
    @Override
    public void addParentItem(Comment parentItem) {
        this.parentItem = add(this.parentItem, parentItem);
    }
