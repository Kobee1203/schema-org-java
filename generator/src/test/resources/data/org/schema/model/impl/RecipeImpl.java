...
public class RecipeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Recipe {
     ...
     */
    @Override
    public void setRecipeInstructions(Text fRecipeInstructions) {
        this.fRecipeInstructions = fRecipeInstructions;
    }
    /**
     * A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
     *
     ...
     */
    @Override
    public void setRecipeInstructions(java.lang.String fRecipeInstructions) {
        this.fRecipeInstructions = Text.of(fRecipeInstructions);
    }
    /**
     * A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
     *
     ...
     */
    @Override
    public void setRecipeInstructions(CreativeWork fRecipeInstructions) {
        this.fRecipeInstructions = fRecipeInstructions;
    }
    /**
     * A step in making the recipe, in the form of a single item (document, video, etc.) or an ordered list with HowToStep and/or HowToSection items.
     ...
     */
    @Override
    public void setRecipeInstructions(ItemList fRecipeInstructions) {
        this.fRecipeInstructions = fRecipeInstructions;
    }

    private Text fIngredients;
     ...
     */
    @Override
    public void setIngredients(Text fIngredients) {
     ...
     */
    @Override
    public void setIngredients(java.lang.String fIngredients) {
        this.fIngredients = Text.of(fIngredients);
    }

    private Text fRecipeCuisine;
     ...
     */
    @Override
    public void setRecipeCuisine(Text fRecipeCuisine) {
        this.fRecipeCuisine = fRecipeCuisine;
    }
    /**
     * The cuisine of the recipe (for example, French or Ethiopian).
     *
     ...
     */
    @Override
    public void setRecipeCuisine(java.lang.String fRecipeCuisine) {
        this.fRecipeCuisine = Text.of(fRecipeCuisine);
    }
     ...
     */
    @Override
    public void setCookingMethod(Text fCookingMethod) {
        this.fCookingMethod = fCookingMethod;
    }
    /**
     * The method of cooking, such as Frying, Steaming, ...
     *
     ...
     */
    @Override
    public void setCookingMethod(java.lang.String fCookingMethod) {
        this.fCookingMethod = Text.of(fCookingMethod);
    }

    private Text fRecipeIngredient;
     ...
     */
    @Override
    public void setRecipeIngredient(Text fRecipeIngredient) {
        this.fRecipeIngredient = fRecipeIngredient;
    }
    /**
     * A single ingredient used in the recipe, e.g. sugar, flour or garlic.
     *
     ...
     */
    @Override
    public void setRecipeIngredient(java.lang.String fRecipeIngredient) {
        this.fRecipeIngredient = Text.of(fRecipeIngredient);
    }

    private Object fRecipeYield;
     ...
     */
    @Override
    public void setRecipeYield(Text fRecipeYield) {
        this.fRecipeYield = fRecipeYield;
    }
    /**
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     *
     ...
     */
    @Override
    public void setRecipeYield(java.lang.String fRecipeYield) {
        this.fRecipeYield = Text.of(fRecipeYield);
    }
    /**
     * The quantity produced by the recipe (for example, number of people served, number of servings, etc).
     *
     ...
     */
    @Override
    public void setRecipeYield(QuantitativeValue fRecipeYield) {
        this.fRecipeYield = fRecipeYield;
    }

    private Duration fCookTime;
     ...
     */
    @Override
    public void setCookTime(Duration fCookTime) {
        this.fCookTime = fCookTime;
    }

    private Text fRecipeCategory;
     ...
     */
    @Override
    public void setRecipeCategory(Text fRecipeCategory) {
        this.fRecipeCategory = fRecipeCategory;
    }
    /**
     * The category of the recipe—for example, appetizer, entree, etc.
     *
     ...
     */
    @Override
    public void setRecipeCategory(java.lang.String fRecipeCategory) {
        this.fRecipeCategory = Text.of(fRecipeCategory);
    }
     ...
     */
    @Override
    public void setYield(Text fYield) {
        this.fYield = fYield;
    }
    /**
     * The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles.
     ...
     */
    @Override
    public void setYield(java.lang.String fYield) {
        this.fYield = Text.of(fYield);
    }
    /**
     * The quantity that results by performing instructions. For example, a paper airplane, 10 personalized candles.
     *
     ...
     */
    @Override
    public void setYield(QuantitativeValue fYield) {
        this.fYield = fYield;
    }
     ...
     */
    @Override
    public void setSupply(HowToSupply fSupply) {
     ...
     */
    @Override
    public void setSupply(Text fSupply) {
        this.fSupply = fSupply;
    }
    /**
     * A sub-property of instrument. A supply consumed when performing instructions or a direction.
     ...
     */
    @Override
    public void setSupply(java.lang.String fSupply) {
        this.fSupply = Text.of(fSupply);
    }

    private Object fStep;
     ...
     */
    @Override
    public void setStep(HowToStep fStep) {
        this.fStep = fStep;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
     ...
     */
    @Override
    public void setStep(HowToSection fStep) {
        this.fStep = fStep;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
     ...
     */
    @Override
    public void setStep(Text fStep) {
        this.fStep = fStep;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
     ...
     */
    @Override
    public void setStep(java.lang.String fStep) {
        this.fStep = Text.of(fStep);
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection.
     *
     ...
     */
    @Override
    public void setStep(CreativeWork fStep) {
        this.fStep = fStep;
    }

    private Duration fTotalTime;
     ...
     */
    @Override
    public void setTotalTime(Duration fTotalTime) {
        this.fTotalTime = fTotalTime;
    }

    private Object fTool;
     ...
     */
    @Override
    public void setTool(HowToTool fTool) {
        this.fTool = fTool;
    }
    /**
     * A sub property of instrument. An object used (but not consumed) when performing instructions or a direction.
     ...
     */
    @Override
    public void setTool(Text fTool) {
        this.fTool = fTool;
    }
    /**
     * A sub property of instrument. An object used (but not consumed) when performing instructions or a direction.
     ...
     */
    @Override
    public void setTool(java.lang.String fTool) {
        this.fTool = Text.of(fTool);
    }

    private Duration fPrepTime;
     ...
     */
    @Override
    public void setPrepTime(Duration fPrepTime) {
        this.fPrepTime = fPrepTime;
    }
     ...
     */
    @Override
    public void setSteps(ItemList fSteps) {
        this.fSteps = fSteps;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection (originally misnamed 'steps'; 'step' is preferred).
     ...
     */
    @Override
    public void setSteps(CreativeWork fSteps) {
        this.fSteps = fSteps;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection (originally misnamed 'steps'; 'step' is preferred).
     ...
     */
    @Override
    public void setSteps(Text fSteps) {
        this.fSteps = fSteps;
    }
    /**
     * A single step item (as HowToStep, text, document, video, etc.) or a HowToSection (originally misnamed 'steps'; 'step' is preferred).
     ...
     */
    @Override
    public void setSteps(java.lang.String fSteps) {
        this.fSteps = Text.of(fSteps);
    }

    private Duration fPerformTime;
     ...
     */
    @Override
    public void setPerformTime(Duration fPerformTime) {
        this.fPerformTime = fPerformTime;
    }
