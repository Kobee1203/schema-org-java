...
public class RecipeImpl implements Recipe {
     ...
     */
    @Override
    public void setRecipeInstructions(Object fRecipeInstructions) {
        if(!(fRecipeInstructions instanceof Text) && !(fRecipeInstructions instanceof CreativeWork) && !(fRecipeInstructions instanceof ItemList)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'recipeInstructions': " + fRecipeInstructions);
        }
     ...
     */
    @Override
    public void setRecipeYield(Object fRecipeYield) {
        if(!(fRecipeYield instanceof Text) && !(fRecipeYield instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'recipeYield': " + fRecipeYield);
        }
     ...
     */
    @Override
    public void setYield(Object fYield) {
        if(!(fYield instanceof Text) && !(fYield instanceof QuantitativeValue)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'yield': " + fYield);
        }
        this.fYield = fYield;
    }
     ...
     */
    @Override
    public void setSupply(Object fSupply) {
        if(!(fSupply instanceof HowToSupply) && !(fSupply instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'supply': " + fSupply);
        }
     ...
     */
    @Override
    public void setStep(Object fStep) {
        if(!(fStep instanceof HowToStep) && !(fStep instanceof HowToSection) && !(fStep instanceof Text) && !(fStep instanceof CreativeWork)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'step': " + fStep);
        }
        this.fStep = fStep;
    }
     ...
     */
    @Override
    public void setTool(Object fTool) {
        if(!(fTool instanceof HowToTool) && !(fTool instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'tool': " + fTool);
        }
        this.fTool = fTool;
    }
     ...
     */
    @Override
    public void setSteps(Object fSteps) {
        if(!(fSteps instanceof ItemList) && !(fSteps instanceof CreativeWork) && !(fSteps instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'steps': " + fSteps);
        }
        this.fSteps = fSteps;
    }
