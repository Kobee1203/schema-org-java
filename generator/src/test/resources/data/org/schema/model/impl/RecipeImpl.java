...
public class RecipeImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Recipe {
    ...
    @JsonLdFieldTypes({ ItemList.class, PropertyValue.class, Text.class })
    private List<Object> recipeIngredient;
     ...
     */
    @Override
    public <T> List<T> getRecipeIngredientList() {
        return (List<T>) recipeIngredient;
    }
     ...
     */
    @Override
    public <T> T getRecipeIngredient() {
        return (T) getFirst(recipeIngredient);
    }
     ...
     */
    @Override
    public void addRecipeIngredient(ItemList recipeIngredient) {
     ...
     */
    @Override
    public void addRecipeIngredient(PropertyValue recipeIngredient) {
        this.recipeIngredient = add(this.recipeIngredient, recipeIngredient);
    }
    /**
     * An ingredient or ordered list of ingredients and potentially quantities used in the recipe, e.g. 1 cup of sugar, flour or garlic.  The ingredients can be represented as free text or more structured values.
