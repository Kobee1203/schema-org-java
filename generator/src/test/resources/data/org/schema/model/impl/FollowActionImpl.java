...
public class FollowActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements FollowAction {
     ...
     */
    @Override
    public <T> List<T> getFolloweeList() {
        return (List<T>) followee;
    }
     ...
     */
    @Override
    public <T> T getFollowee() {
        return (T) getFirst(followee);
    }
     ...
     */
    @Override
    public void addFollowee(Person followee) {
        this.followee = add(this.followee, followee);
    }
    /**
     * A sub property of object. The person or organization being followed.
     *
     ...
     */
    @Override
    public void addFollowee(Organization followee) {
        this.followee = add(this.followee, followee);
    }
