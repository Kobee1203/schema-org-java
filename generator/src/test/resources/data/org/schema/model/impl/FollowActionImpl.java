...
public class FollowActionImpl implements FollowAction {
     ...
     */
    @Override
    public void setFollowee(Object fFollowee) {
        if(!(fFollowee instanceof Organization) && !(fFollowee instanceof Person)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'followee': " + fFollowee);
        }
        this.fFollowee = fFollowee;
    }
