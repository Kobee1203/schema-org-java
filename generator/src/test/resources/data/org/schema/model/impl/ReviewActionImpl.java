...
public class ReviewActionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ReviewAction {
    ...
    private List<Review> resultReview;
     ...
     */
    @Override
    public List<Review> getResultReviewList() {
        return resultReview;
    }
     ...
     */
    @Override
    public void addResultReview(Review resultReview) {
        this.resultReview = add(this.resultReview, resultReview);
    }
