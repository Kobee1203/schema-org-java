...
public class HyperTocEntryImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements HyperTocEntry {
    ...
    private List<HyperTocEntry> tocContinuation;
     ...
     */
    @Override
    public List<HyperTocEntry> getTocContinuationList() {
    ...
    public HyperTocEntry getTocContinuation() {
        return getFirst(tocContinuation);
    }
     ...
     */
    @Override
    public void addTocContinuation(HyperTocEntry tocContinuation) {
        this.tocContinuation = add(this.tocContinuation, tocContinuation);
    }

    private List<Text> utterances;
     ...
     */
    @Override
    public List<Text> getUtterancesList() {
        return utterances;
    }
     ...
     */
    @Override
    public void addUtterances(Text utterances) {
        this.utterances = add(this.utterances, utterances);
    }
