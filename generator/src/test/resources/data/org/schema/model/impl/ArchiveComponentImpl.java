 ...
 */
@JsonLdTypeName("ArchiveComponent")
public class ArchiveComponentImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ArchiveComponent {

    private List<ArchiveOrganization> holdingArchive;
     ...
     */
    @Override
    public List<ArchiveOrganization> getHoldingArchiveList() {
    ...
    public ArchiveOrganization getHoldingArchive() {
        return getFirst(holdingArchive);
    }
     ...
     */
    @Override
    public void addHoldingArchive(ArchiveOrganization holdingArchive) {
        this.holdingArchive = add(this.holdingArchive, holdingArchive);
    }

    @JsonLdFieldTypes({ Place.class, Text.class, PostalAddress.class })
    private List<Object> itemLocation;
     ...
     */
    @Override
    public <T> List<T> getItemLocationList() {
        return (List<T>) itemLocation;
    }
     ...
     */
    @Override
    public <T> T getItemLocation() {
        return (T) getFirst(itemLocation);
    }
     ...
     */
    @Override
    public void addItemLocation(Place itemLocation) {
        this.itemLocation = add(this.itemLocation, itemLocation);
    }
    /**
     * Current location of the item.
     *
     ...
     */
    @Override
    public void addItemLocation(Text itemLocation) {
        this.itemLocation = add(this.itemLocation, itemLocation);
    }
    /**
     * Current location of the item.
     ...
     */
    @Override
    public void addItemLocation(PostalAddress itemLocation) {
        this.itemLocation = add(this.itemLocation, itemLocation);
    }
