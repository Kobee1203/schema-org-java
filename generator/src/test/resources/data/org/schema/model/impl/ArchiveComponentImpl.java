...
public class ArchiveComponentImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ArchiveComponent {
     ...
     */
    @Override
    public void setHoldingArchive(ArchiveOrganization fHoldingArchive) {
        this.fHoldingArchive = fHoldingArchive;
    }

    private Object fItemLocation;
     ...
     */
    @Override
    public void setItemLocation(Object fItemLocation) {
        if(!(fItemLocation instanceof Place) && !(fItemLocation instanceof Text) && !(fItemLocation instanceof PostalAddress)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'itemLocation': " + fItemLocation);
        }
        this.fItemLocation = fItemLocation;
    }
