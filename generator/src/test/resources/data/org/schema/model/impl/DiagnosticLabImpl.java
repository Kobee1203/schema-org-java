...
public class DiagnosticLabImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements DiagnosticLab {
    ...
    private List<MedicalTest> availableTest;
     ...
     */
    @Override
    public List<MedicalTest> getAvailableTestList() {
     ...
     */
    @Override
    public void addAvailableTest(MedicalTest availableTest) {
        this.availableTest = add(this.availableTest, availableTest);
    }
