...
public class AnswerImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Answer {
    ...
    @JsonLdFieldTypes({ Comment.class, WebContent.class })
    private List<Object> answerExplanation;
     ...
     */
    @Override
    public <T> List<T> getAnswerExplanationList() {
        return (List<T>) answerExplanation;
    }
     ...
     */
    @Override
    public <T> T getAnswerExplanation() {
        return (T) getFirst(answerExplanation);
    }
     ...
     */
    @Override
    public void addAnswerExplanation(Comment answerExplanation) {
        this.answerExplanation = add(this.answerExplanation, answerExplanation);
    }
    /**
     * A step-by-step or full explanation about Answer. Can outline how this Answer was achieved or contain more broad clarification or statement about it. 
     *
     ...
     */
    @Override
    public void addAnswerExplanation(WebContent answerExplanation) {
        this.answerExplanation = add(this.answerExplanation, answerExplanation);
    }
