...
public class AnswerImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Answer {
     ...
     */
    @Override
    public void setAnswerExplanation(Object fAnswerExplanation) {
        if(!(fAnswerExplanation instanceof WebContent) && !(fAnswerExplanation instanceof Comment)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'answerExplanation': " + fAnswerExplanation);
        }
