...
public class BedDetailsImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements BedDetails {
     ...
     */
    @Override
    public void setTypeOfBed(BedType fTypeOfBed) {
     ...
     */
    @Override
    public void setTypeOfBed(Text fTypeOfBed) {
        this.fTypeOfBed = fTypeOfBed;
    }
    /**
     * The type of bed to which the BedDetail refers, i.e. the type of bed available in the quantity indicated by quantity.
     ...
     */
    @Override
    public void setTypeOfBed(java.lang.String fTypeOfBed) {
        this.fTypeOfBed = Text.of(fTypeOfBed);
    }
     ...
     */
    @Override
    public void setNumberOfBeds(java.lang.Number fNumberOfBeds) {
        this.fNumberOfBeds = Number.of(fNumberOfBeds);
    }
