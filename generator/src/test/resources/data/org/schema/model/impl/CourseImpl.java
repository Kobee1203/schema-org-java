...
public class CourseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Course {
    ...
    private List<Syllabus> syllabusSections;
     ...
     */
    @Override
    public List<Syllabus> getSyllabusSectionsList() {
     ...
     */
    @Override
    public Syllabus getSyllabusSections() {
        return getFirst(syllabusSections);
    }
     ...
     */
    @Override
    public void addSyllabusSections(Syllabus syllabusSections) {
        this.syllabusSections = add(this.syllabusSections, syllabusSections);
    }
    ...
    private List<CourseInstance> hasCourseInstance;
     ...
     */
    @Override
    public List<CourseInstance> getHasCourseInstanceList() {
    ...
    public CourseInstance getHasCourseInstance() {
        return getFirst(hasCourseInstance);
    }
     ...
     */
    @Override
    public void addHasCourseInstance(CourseInstance hasCourseInstance) {
        this.hasCourseInstance = add(this.hasCourseInstance, hasCourseInstance);
    }

    private List<Integer> totalHistoricalEnrollment;
     ...
     */
    @Override
    public List<Integer> getTotalHistoricalEnrollmentList() {
        return totalHistoricalEnrollment;
    }
     ...
     */
    @Override
    public Integer getTotalHistoricalEnrollment() {
        return getFirst(totalHistoricalEnrollment);
    }
     ...
     */
    @Override
    public void addTotalHistoricalEnrollment(Integer totalHistoricalEnrollment) {
        this.totalHistoricalEnrollment = add(this.totalHistoricalEnrollment, totalHistoricalEnrollment);
    }
    ...
    @JsonLdFieldTypes({ Course.class, AlignmentObject.class, Text.class })
    private List<Object> coursePrerequisites;
     ...
     */
    @Override
    public <T> List<T> getCoursePrerequisitesList() {
        return (List<T>) coursePrerequisites;
    }
    ...
    public <T> T getCoursePrerequisites() {
        return (T) getFirst(coursePrerequisites);
    }
     ...
     */
    @Override
    public void addCoursePrerequisites(Course coursePrerequisites) {
        this.coursePrerequisites = add(this.coursePrerequisites, coursePrerequisites);
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     *
     ...
     */
    @Override
    public void addCoursePrerequisites(AlignmentObject coursePrerequisites) {
        this.coursePrerequisites = add(this.coursePrerequisites, coursePrerequisites);
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     ...
     */
    @Override
    public void addCoursePrerequisites(Text coursePrerequisites) {
        this.coursePrerequisites = add(this.coursePrerequisites, coursePrerequisites);
    }
     ...
     */
    @Override
    public List<Text> getCourseCodeList() {
        return courseCode;
    }
     ...
     */
    @Override
    public void addCourseCode(Text courseCode) {
        this.courseCode = add(this.courseCode, courseCode);
    }
