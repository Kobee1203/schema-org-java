...
public class CourseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Course {
     ...
     */
    @Override
    public void setCoursePrerequisites(Object fCoursePrerequisites) {
        if(!(fCoursePrerequisites instanceof Text) && !(fCoursePrerequisites instanceof AlignmentObject) && !(fCoursePrerequisites instanceof Course)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'coursePrerequisites': " + fCoursePrerequisites);
        }
