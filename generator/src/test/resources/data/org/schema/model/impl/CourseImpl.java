...
public class CourseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Course {
     ...
     */
    @Override
    public <T> T getCoursePrerequisites() {
        return (T) fCoursePrerequisites;
    }
     ...
     */
    @Override
    public void setCoursePrerequisites(Text fCoursePrerequisites) {
        this.fCoursePrerequisites = fCoursePrerequisites;
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     *
     ...
     */
    @Override
    public void setCoursePrerequisites(java.lang.String fCoursePrerequisites) {
        this.fCoursePrerequisites = Text.of(fCoursePrerequisites);
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     *
     ...
     */
    @Override
    public void setCoursePrerequisites(AlignmentObject fCoursePrerequisites) {
        this.fCoursePrerequisites = fCoursePrerequisites;
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     ...
     */
    @Override
    public void setCoursePrerequisites(Course fCoursePrerequisites) {
        this.fCoursePrerequisites = fCoursePrerequisites;
    }
     ...
     */
    @Override
    public void setCourseCode(Text fCourseCode) {
     ...
     */
    @Override
    public void setCourseCode(java.lang.String fCourseCode) {
        this.fCourseCode = Text.of(fCourseCode);
    }

    private CourseInstance fHasCourseInstance;
     ...
     */
    @Override
    public void setHasCourseInstance(CourseInstance fHasCourseInstance) {
        this.fHasCourseInstance = fHasCourseInstance;
    }
    ...
    private Object fCompetencyRequired;
     ...
     */
    @Override
    public void setCompetencyRequired(Text fCompetencyRequired) {
        this.fCompetencyRequired = fCompetencyRequired;
    }
    /**
     * Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource.
     *
     ...
     */
    @Override
    public void setCompetencyRequired(java.lang.String fCompetencyRequired) {
        this.fCompetencyRequired = Text.of(fCompetencyRequired);
    }
    /**
     * Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource.
     *
     ...
     */
    @Override
    public void setCompetencyRequired(DefinedTerm fCompetencyRequired) {
        this.fCompetencyRequired = fCompetencyRequired;
    }
    /**
     * Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource.
     ...
     */
    @Override
    public void setCompetencyRequired(URL fCompetencyRequired) {
        this.fCompetencyRequired = fCompetencyRequired;
    }
    /**
     * Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource.
     ...
     */
    @Override
    public void setCompetencyRequired(java.net.URL fCompetencyRequired) {
        this.fCompetencyRequired = URL.of(fCompetencyRequired);
    }
