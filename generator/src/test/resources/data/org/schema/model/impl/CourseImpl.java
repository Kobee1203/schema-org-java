...
public class CourseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements Course {
    ...
    private Object coursePrerequisites;
     ...
     */
    @Override
    public void setCoursePrerequisites(Text coursePrerequisites) {
     ...
     */
    @Override
    public void setCoursePrerequisites(AlignmentObject coursePrerequisites) {
        this.coursePrerequisites = coursePrerequisites;
    }
    /**
     * Requirements for taking the Course. May be completion of another [[Course]] or a textual description like "permission of instructor". Requirements may be a pre-requisite competency, referenced using [[AlignmentObject]].
     ...
     */
    @Override
    public void setCoursePrerequisites(Course coursePrerequisites) {
        this.coursePrerequisites = coursePrerequisites;
    }
     ...
     */
    @Override
    public void setCourseCode(Text courseCode) {
     ...
     */
    @Override
    public void setCompetencyRequired(Text competencyRequired) {
     ...
     */
    @Override
    public void setCompetencyRequired(DefinedTerm competencyRequired) {
        this.competencyRequired = competencyRequired;
    }
    /**
     * Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource.
     ...
     */
    @Override
    public void setCompetencyRequired(URL competencyRequired) {
        this.competencyRequired = competencyRequired;
    }
