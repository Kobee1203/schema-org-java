...
public class MoneyTransferImpl implements MoneyTransfer {
     ...
     */
    @Override
    public void setBeneficiaryBank(Object fBeneficiaryBank) {
        if(!(fBeneficiaryBank instanceof BankOrCreditUnion) && !(fBeneficiaryBank instanceof Text)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'beneficiaryBank': " + fBeneficiaryBank);
        }
