...
public class MoneyTransferImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MoneyTransfer {
    ...
    @JsonLdFieldTypes({ BankOrCreditUnion.class, Text.class })
    private List<Object> beneficiaryBank;
    ...
    public <T> T getBeneficiaryBank() {
        return (T) getFirst(beneficiaryBank);
    }
    ...
    public void addBeneficiaryBank(BankOrCreditUnion beneficiaryBank) {
        this.beneficiaryBank = add(this.beneficiaryBank, beneficiaryBank);
    }
    /**
     * A bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank account or releasing funds for the beneficiary.
     *
