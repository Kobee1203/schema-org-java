...
import org.schema.model.MediaReview;
...
public class MediaReviewImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MediaReview {
    ...
    @JsonLdFieldTypes({ WebPage.class, MediaObject.class, URL.class })
    private List<Object> originalMediaLink;
     ...
     */
    @Override
    public <T> List<T> getOriginalMediaLinkList() {
        return (List<T>) originalMediaLink;
    }
     ...
     */
    @Override
    public <T> T getOriginalMediaLink() {
        return (T) getFirst(originalMediaLink);
    }
     ...
     */
    @Override
    public void addOriginalMediaLink(WebPage originalMediaLink) {
        this.originalMediaLink = add(this.originalMediaLink, originalMediaLink);
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     *
     ...
     */
    @Override
    public void addOriginalMediaLink(MediaObject originalMediaLink) {
        this.originalMediaLink = add(this.originalMediaLink, originalMediaLink);
    }
    /**
     * Link to the page containing an original version of the content, or directly to an online copy of the original [[MediaObject]] content, e.g. video file.
     ...
     */
    @Override
    public void addOriginalMediaLink(URL originalMediaLink) {
        this.originalMediaLink = add(this.originalMediaLink, originalMediaLink);
    }

    private List<Text> originalMediaContextDescription;
     ...
     */
    @Override
    public List<Text> getOriginalMediaContextDescriptionList() {
     ...
     */
    @Override
    public Text getOriginalMediaContextDescription() {
        return getFirst(originalMediaContextDescription);
    }
     ...
     */
    @Override
    public void addOriginalMediaContextDescription(Text originalMediaContextDescription) {
        this.originalMediaContextDescription = add(this.originalMediaContextDescription, originalMediaContextDescription);
    }

    private List<MediaManipulationRatingEnumeration> mediaAuthenticityCategory;
     ...
     */
    @Override
    public List<MediaManipulationRatingEnumeration> getMediaAuthenticityCategoryList() {
    ...
    public MediaManipulationRatingEnumeration getMediaAuthenticityCategory() {
        return getFirst(mediaAuthenticityCategory);
    }
     ...
     */
    @Override
    public void addMediaAuthenticityCategory(MediaManipulationRatingEnumeration mediaAuthenticityCategory) {
        this.mediaAuthenticityCategory = add(this.mediaAuthenticityCategory, mediaAuthenticityCategory);
    }
