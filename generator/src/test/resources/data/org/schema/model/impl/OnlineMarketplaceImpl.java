 ...
 */
@JsonLdTypeName("OnlineMarketplace")
public class OnlineMarketplaceImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements OnlineMarketplace {

    private List<OnlineStore> hasStore;
     ...
     */
    @Override
    public List<OnlineStore> getHasStoreList() {
        return hasStore;
    }
     ...
     */
    @Override
    public OnlineStore getHasStore() {
        return getFirst(hasStore);
    }
     ...
     */
    @Override
    public void addHasStore(OnlineStore hasStore) {
        this.hasStore = add(this.hasStore, hasStore);
    }

    private List<OnlineMarketplace> isStoreOn;
     ...
     */
    @Override
    public List<OnlineMarketplace> getIsStoreOnList() {
        return isStoreOn;
    }
     ...
     */
    @Override
    public OnlineMarketplace getIsStoreOn() {
        return getFirst(isStoreOn);
    }
     ...
     */
    @Override
    public void addIsStoreOn(OnlineMarketplace isStoreOn) {
        this.isStoreOn = add(this.isStoreOn, isStoreOn);
    }
