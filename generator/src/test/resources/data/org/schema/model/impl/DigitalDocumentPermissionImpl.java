...
public class DigitalDocumentPermissionImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements DigitalDocumentPermission {
    ...
    @JsonLdFieldTypes({ Audience.class, Organization.class, ContactPoint.class, Person.class })
    private List<Object> grantee;
     ...
     */
    @Override
    public <T> List<T> getGranteeList() {
        return (List<T>) grantee;
    }
     ...
     */
    @Override
    public <T> T getGrantee() {
        return (T) getFirst(grantee);
    }
     ...
     */
    @Override
    public void addGrantee(Audience grantee) {
        this.grantee = add(this.grantee, grantee);
    }
    /**
     * The person, organization, contact point, or audience that has been granted this permission.
     *
     ...
     */
    @Override
    public void addGrantee(Organization grantee) {
        this.grantee = add(this.grantee, grantee);
    }
    /**
     * The person, organization, contact point, or audience that has been granted this permission.
     ...
     */
    @Override
    public void addGrantee(ContactPoint grantee) {
        this.grantee = add(this.grantee, grantee);
    }
    /**
     * The person, organization, contact point, or audience that has been granted this permission.
     ...
     */
    @Override
    public void addGrantee(Person grantee) {
        this.grantee = add(this.grantee, grantee);
    }

    private List<DigitalDocumentPermissionType> permissionType;
     ...
     */
    @Override
    public List<DigitalDocumentPermissionType> getPermissionTypeList() {
    ...
    public DigitalDocumentPermissionType getPermissionType() {
        return getFirst(permissionType);
    }
     ...
     */
    @Override
    public void addPermissionType(DigitalDocumentPermissionType permissionType) {
        this.permissionType = add(this.permissionType, permissionType);
    }
