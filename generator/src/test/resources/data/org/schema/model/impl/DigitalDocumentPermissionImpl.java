...
public class DigitalDocumentPermissionImpl implements DigitalDocumentPermission {
     ...
     */
    @Override
    public void setGrantee(Object fGrantee) {
        if(!(fGrantee instanceof Person) && !(fGrantee instanceof Audience) && !(fGrantee instanceof ContactPoint) && !(fGrantee instanceof Organization)) {
            throw new java.lang.IllegalArgumentException("Invalid value for property 'grantee': " + fGrantee);
        }
        this.fGrantee = fGrantee;
    }

    private DigitalDocumentPermissionType fPermissionType;
     ...
     */
    @Override
    public void setPermissionType(DigitalDocumentPermissionType fPermissionType) {
