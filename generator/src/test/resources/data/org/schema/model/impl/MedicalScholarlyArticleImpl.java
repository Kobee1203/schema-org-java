...
public class MedicalScholarlyArticleImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalScholarlyArticle {
     ...
     */
    @Override
    public Text getPublicationType() {
        return fPublicationType;
    }
     ...
     */
    @Override
    public void setPublicationType(Text fPublicationType) {
        this.fPublicationType = fPublicationType;
    }
    /**
     * The type of the medical article, taken from the US NLM MeSH publication type catalog. See also [MeSH documentation](http://www.nlm.nih.gov/mesh/pubtypes.html).
     *
     ...
     */
    @Override
    public void setPublicationType(java.lang.String fPublicationType) {
        this.fPublicationType = Text.of(fPublicationType);
    }
