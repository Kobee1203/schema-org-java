...
public class MedicalScholarlyArticleImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalScholarlyArticle {
    ...
    private List<Text> publicationType;
     ...
     */
    @Override
    public List<Text> getPublicationTypeList() {
    ...
    public Text getPublicationType() {
        return getFirst(publicationType);
    }
     ...
     */
    @Override
    public void addPublicationType(Text publicationType) {
        this.publicationType = add(this.publicationType, publicationType);
    }
