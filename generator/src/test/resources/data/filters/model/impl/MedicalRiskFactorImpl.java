...
public class MedicalRiskFactorImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalRiskFactor {
    ...
    private List<MedicalEntity> increasesRiskOf;

    @Override
    public List<MedicalEntity> getIncreasesRiskOfList() {
        return increasesRiskOf;
    }

    @Override
    public MedicalEntity getIncreasesRiskOf() {
        return getFirst(increasesRiskOf);
    }

    @Override
    public void addIncreasesRiskOf(MedicalEntity increasesRiskOf) {
        this.increasesRiskOf = add(this.increasesRiskOf, increasesRiskOf);
    }
