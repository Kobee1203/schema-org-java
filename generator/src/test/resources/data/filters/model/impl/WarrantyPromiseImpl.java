...
public class WarrantyPromiseImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements WarrantyPromise {
    ...
    private List<QuantitativeValue> durationOfWarranty;
    ...
    public QuantitativeValue getDurationOfWarranty() {
        return getFirst(durationOfWarranty);
    }

    @Override
    public void addDurationOfWarranty(QuantitativeValue durationOfWarranty) {
        this.durationOfWarranty = add(this.durationOfWarranty, durationOfWarranty);
    }
    ...
    private List<WarrantyScope> warrantyScope;
    ...
    public WarrantyScope getWarrantyScope() {
        return getFirst(warrantyScope);
    }

    @Override
    public void addWarrantyScope(WarrantyScope warrantyScope) {
        this.warrantyScope = add(this.warrantyScope, warrantyScope);
    }
}
