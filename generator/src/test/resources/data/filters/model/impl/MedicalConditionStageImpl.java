...
public class MedicalConditionStageImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements MedicalConditionStage {
    ...
    private List<Number> stageAsNumber;

    @Override
    public List<Number> getStageAsNumberList() {
        return stageAsNumber;
    }

    @Override
    public Number getStageAsNumber() {
        return getFirst(stageAsNumber);
    }

    @Override
    public void addStageAsNumber(Number stageAsNumber) {
        this.stageAsNumber = add(this.stageAsNumber, stageAsNumber);
    }
    ...
    private List<Text> subStageSuffix;

    @Override
    public List<Text> getSubStageSuffixList() {
        return subStageSuffix;
    }

    @Override
    public Text getSubStageSuffix() {
        return getFirst(subStageSuffix);
    }

    @Override
    public void addSubStageSuffix(Text subStageSuffix) {
        this.subStageSuffix = add(this.subStageSuffix, subStageSuffix);
    }
