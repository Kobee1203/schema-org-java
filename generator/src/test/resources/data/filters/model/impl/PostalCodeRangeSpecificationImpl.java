...
public class PostalCodeRangeSpecificationImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements PostalCodeRangeSpecification {
    ...
    private List<Text> postalCodeBegin;

    @Override
    public List<Text> getPostalCodeBeginList() {
        return postalCodeBegin;
    }

    @Override
    public Text getPostalCodeBegin() {
        return getFirst(postalCodeBegin);
    }

    @Override
    public void addPostalCodeBegin(Text postalCodeBegin) {
        this.postalCodeBegin = add(this.postalCodeBegin, postalCodeBegin);
    }

    private List<Text> postalCodeEnd;

    @Override
    public List<Text> getPostalCodeEndList() {
        return postalCodeEnd;
    }

    @Override
    public Text getPostalCodeEnd() {
        return getFirst(postalCodeEnd);
    }

    @Override
    public void addPostalCodeEnd(Text postalCodeEnd) {
        this.postalCodeEnd = add(this.postalCodeEnd, postalCodeEnd);
    }
