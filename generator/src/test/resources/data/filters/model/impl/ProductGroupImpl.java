...
public class ProductGroupImpl extends com.weedow.schemaorg.commons.model.JsonLdNodeImpl implements ProductGroup {
    ...
    private List<Product> hasVariant;

    @Override
    public List<Product> getHasVariantList() {
        return hasVariant;
    }

    @Override
    public Product getHasVariant() {
        return getFirst(hasVariant);
    }

    @Override
    public void addHasVariant(Product hasVariant) {
        this.hasVariant = add(this.hasVariant, hasVariant);
    }
    ...
    private List<Text> productGroupID;

    @Override
    public List<Text> getProductGroupIDList() {
        return productGroupID;
    }

    @Override
    public Text getProductGroupID() {
        return getFirst(productGroupID);
    }

    @Override
    public void addProductGroupID(Text productGroupID) {
        this.productGroupID = add(this.productGroupID, productGroupID);
    }
    ...
    @JsonLdFieldTypes({ DefinedTerm.class, Text.class })
    private List<Object> variesBy;

    @Override
    public <T> List<T> getVariesByList() {
        return (List<T>) variesBy;
    }

    @Override
    public <T> T getVariesBy() {
        return (T) getFirst(variesBy);
    }

    @Override
    public void addVariesBy(DefinedTerm variesBy) {
        this.variesBy = add(this.variesBy, variesBy);
    }
    @Override
    public void addVariesBy(Text variesBy) {
        this.variesBy = add(this.variesBy, variesBy);
    }
